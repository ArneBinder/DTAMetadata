...
abstract class BaseTitletype extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Description\\TitletypePeer';
     ...
     * @return Titletype The current object (for fluent API support)
     */
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = TitletypePeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = TitletypePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TitletypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TitletypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TitletypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->titlesScheduledForDeletion !== null) {
                if (!$this->titlesScheduledForDeletion->isEmpty()) {
                    TitleQuery::create()
                        ->filterByPrimaryKeys($this->titlesScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TitletypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`ID`';
        }
        if ($this->isColumnModified(TitletypePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`NAME`';
        }

        $sql = sprintf(
            'INSERT INTO `titleType` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['Titletype'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Titletype'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TitletypePeer::NAME)) $criteria->add(TitletypePeer::NAME, $this->name);
     ...
     * objects.
     *
     * @param object $copyObj An object of Titletype (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Titletype Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Titletype is new, it will return
    ...
    public function setTitles(PropelCollection $titles, PropelPDO $con = null)
    {
        ...
        foreach ($this->titlesScheduledForDeletion as $titleRemoved) {
            $titleRemoved->setTitletype(null);
        }
     ...
     * Otherwise if this Titletype is new, it will return
     * an empty collection; or if this Titletype has previously
     * been saved, it will retrieve related Titles from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Titletype.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(TitletypePeer::DEFAULT_STRING_FORMAT);
    }
