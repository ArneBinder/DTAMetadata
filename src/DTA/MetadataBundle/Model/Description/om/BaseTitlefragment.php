...
abstract class BaseTitlefragment extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Description\\TitlefragmentPeer';
     ...
     * @throws PropelException
     */
    public function getTitlefragmenttype(PropelPDO $con = null)
    {
        if ($this->aTitlefragmenttype === null && ($this->titlefragmenttype_id !== null)) {
