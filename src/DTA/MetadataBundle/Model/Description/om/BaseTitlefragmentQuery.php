...
abstract class BaseTitlefragmentQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'DTAMetadata', $modelName = 'DTA\\MetadataBundle\\Model\\Description\\Titlefragment', $modelAlias = null)
    {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \DTA\MetadataBundle\Model\Description\TitlefragmenttypeQuery A secondary query class using the current class as primary query
     */
    public function useTitlefragmenttypeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'Titlefragmenttype', '\DTA\MetadataBundle\Model\Description\TitlefragmenttypeQuery');
    }
