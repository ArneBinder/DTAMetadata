...
abstract class BaseFontPublication extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Master\\FontPublicationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        FontPublicationPeer
     */
     ...
     * @return FontPublication The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = FontPublicationPeer::ID;
        }
    ...
    public function setFontId($v)
    {
        ...
        if ($this->font_id !== $v) {
            $this->font_id = $v;
            $this->modifiedColumns[] = FontPublicationPeer::FONT_ID;
        }
    ...
    public function setPublicationId($v)
    {
        ...
        if ($this->publication_id !== $v) {
            ...
            $this->modifiedColumns[] = FontPublicationPeer::PUBLICATION_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = FontPublicationPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = FontPublicationPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->font_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            return $startcol + 5; // 5 = FontPublicationPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating FontPublication object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = FontPublicationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = FontPublicationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(FontPublicationPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(FontPublicationPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(FontPublicationPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                FontPublicationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('font_publication_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(FontPublicationPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(FontPublicationPeer::FONT_ID)) {
            $modifiedColumns[':p' . $index++]  = '"font_id"';
        }
        if ($this->isColumnModified(FontPublicationPeer::PUBLICATION_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO "font_publication" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = FontPublicationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = FontPublicationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['FontPublication'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['FontPublication'][$this->getPrimaryKey()] = true;
        $keys = FontPublicationPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getFontId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setFontId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(FontPublicationPeer::ID)) $criteria->add(FontPublicationPeer::ID, $this->id);
        if ($this->isColumnModified(FontPublicationPeer::FONT_ID)) $criteria->add(FontPublicationPeer::FONT_ID, $this->font_id);
        if ($this->isColumnModified(FontPublicationPeer::PUBLICATION_ID)) $criteria->add(FontPublicationPeer::PUBLICATION_ID, $this->publication_id);
        if ($this->isColumnModified(FontPublicationPeer::CREATED_AT)) $criteria->add(FontPublicationPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(FontPublicationPeer::UPDATED_AT)) $criteria->add(FontPublicationPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(FontPublicationPeer::DATABASE_NAME);
        $criteria->add(FontPublicationPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of FontPublication (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return FontPublication Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return FontPublicationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new FontPublicationPeer();
        }
    ...
    public function getFont(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aFont === null && ($this->font_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aFont->addFontPublications($this);
             */
        }
    ...
    public function getPublication(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPublication === null && ($this->publication_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPublication->addFontPublications($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(FontPublicationPeer::DEFAULT_STRING_FORMAT);
    }
