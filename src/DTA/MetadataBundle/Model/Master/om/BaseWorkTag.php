...
abstract class BaseWorkTag extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Master\\WorkTagPeer';
     ...
     * @return WorkTag The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = WorkTagPeer::ID;
        }
    ...
    public function setTagId($v)
    {
        ...
        if ($this->tag_id !== $v) {
            $this->tag_id = $v;
            $this->modifiedColumns[] = WorkTagPeer::TAG_ID;
        }
    ...
    public function setWorkId($v)
    {
        ...
        if ($this->work_id !== $v) {
            $this->work_id = $v;
            $this->modifiedColumns[] = WorkTagPeer::WORK_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = WorkTagPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating WorkTag object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = WorkTagPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = WorkTagQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WorkTagPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(WorkTagPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(WorkTagPeer::TAG_ID)) {
            $modifiedColumns[':p' . $index++]  = '"tag_id"';
        }
        if ($this->isColumnModified(WorkTagPeer::WORK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"work_id"';
        }

        $sql = sprintf(
            'INSERT INTO "work_tag" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = WorkTagPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = WorkTagPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['WorkTag'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['WorkTag'][serialize($this->getPrimaryKey())] = true;
        $keys = WorkTagPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(WorkTagPeer::ID)) $criteria->add(WorkTagPeer::ID, $this->id);
        if ($this->isColumnModified(WorkTagPeer::TAG_ID)) $criteria->add(WorkTagPeer::TAG_ID, $this->tag_id);
        if ($this->isColumnModified(WorkTagPeer::WORK_ID)) $criteria->add(WorkTagPeer::WORK_ID, $this->work_id);
    ...
    {
        $criteria = new Criteria(WorkTagPeer::DATABASE_NAME);
        $criteria->add(WorkTagPeer::ID, $this->id);
        $criteria->add(WorkTagPeer::TAG_ID, $this->tag_id);
        $criteria->add(WorkTagPeer::WORK_ID, $this->work_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getId()) && (null === $this->getTagId()) && (null === $this->getWorkId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of WorkTag (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return WorkTag Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(WorkTagPeer::DEFAULT_STRING_FORMAT);
    }
