...
abstract class BaseCategoryWork extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Master\\CategoryWorkPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CategoryWorkPeer
     */
    ...
    public function setCategoryId($v)
    {
        ...
        if ($this->category_id !== $v) {
            $this->category_id = $v;
            $this->modifiedColumns[] = CategoryWorkPeer::CATEGORY_ID;
        }
    ...
    public function setWorkId($v)
    {
        ...
        if ($this->work_id !== $v) {
            $this->work_id = $v;
            $this->modifiedColumns[] = CategoryWorkPeer::WORK_ID;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CategoryWorkPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CategoryWorkQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CategoryWorkPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('category_work_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(CategoryWorkPeer::WORK_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO "category_work" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CategoryWorkPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CategoryWorkPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CategoryWork'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CategoryWork'][$this->getPrimaryKey()] = true;
     ...
     * objects.
     *
     * @param object $copyObj An object of CategoryWork (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CategoryWork Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CategoryWorkPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CategoryWorkPeer();
        }
    ...
    public function getCategory(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCategory === null && ($this->category_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCategory->addCategoryWorks($this);
             */
        }
    ...
    public function getWork(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aWork === null && ($this->work_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aWork->addCategoryWorks($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CategoryWorkPeer::DEFAULT_STRING_FORMAT);
    }
