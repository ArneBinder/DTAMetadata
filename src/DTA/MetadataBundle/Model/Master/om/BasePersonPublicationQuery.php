 ...
 * @method PersonPublicationQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method PersonPublicationQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 ...
 * @method PersonPublicationQuery groupByCreatedAt() Group by the created_at column
 * @method PersonPublicationQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 * @method PersonPublication findOneByCreatedAt(string $created_at) Return the first PersonPublication filtered by the created_at column
 * @method PersonPublication findOneByUpdatedAt(string $updated_at) Return the first PersonPublication filtered by the updated_at column
 *
 ...
 * @method array findByCreatedAt(string $created_at) Return PersonPublication objects filtered by the created_at column
 * @method array findByUpdatedAt(string $updated_at) Return PersonPublication objects filtered by the updated_at column
 */
abstract class BasePersonPublicationQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "id", "person_id", "personrole_id", "publication_id", "created_at", "updated_at" FROM "person_publication" WHERE "id" = :p0';
        try {
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(PersonPublicationPeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(PersonPublicationPeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PersonPublicationPeer::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(PersonPublicationPeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(PersonPublicationPeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PersonPublicationPeer::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(PersonPublicationPeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PersonPublicationPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PersonPublicationPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(PersonPublicationPeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PersonPublicationPeer::CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PersonPublicationPeer::CREATED_AT);
    }
}
