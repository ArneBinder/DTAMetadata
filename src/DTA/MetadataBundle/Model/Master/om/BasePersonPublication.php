...
abstract class BasePersonPublication extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    ...
    public static $tableRowViewCaptions = array('Id', 'PersonId', 'PersonroleId', 'PublicationId', 'CreatedAt', 'UpdatedAt', );	public   $tableRowViewAccessors = array('Id'=>'Id', 'PersonId'=>'PersonId', 'PersonroleId'=>'PersonroleId', 'PublicationId'=>'PublicationId', 'CreatedAt'=>'CreatedAt', 'UpdatedAt'=>'UpdatedAt', );	public static $queryConstructionString = NULL;
    /**
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PersonPublicationPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PersonPublicationPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = PersonPublicationPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PersonPublicationPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PersonPublicationPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PersonPublicationPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PersonPublicationPeer::CREATED_AT)) $criteria->add(PersonPublicationPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PersonPublicationPeer::UPDATED_AT)) $criteria->add(PersonPublicationPeer::UPDATED_AT, $this->updated_at);
