...
abstract class BaseLanguagePublication extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Master\\LanguagePublicationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LanguagePublicationPeer
     */
     ...
     * @return LanguagePublication The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LanguagePublicationPeer::ID;
        }
    ...
    public function setLanguageId($v)
    {
        ...
        if ($this->language_id !== $v) {
            $this->language_id = $v;
            $this->modifiedColumns[] = LanguagePublicationPeer::LANGUAGE_ID;
        }
    ...
    public function setPublicationId($v)
    {
        ...
        if ($this->publication_id !== $v) {
            ...
            $this->modifiedColumns[] = LanguagePublicationPeer::PUBLICATION_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LanguagePublicationPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LanguagePublicationPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = LanguagePublicationPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LanguagePublication object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LanguagePublicationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LanguagePublicationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(LanguagePublicationPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(LanguagePublicationPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(LanguagePublicationPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                LanguagePublicationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('language_publication_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(LanguagePublicationPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(LanguagePublicationPeer::LANGUAGE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"language_id"';
        }
        if ($this->isColumnModified(LanguagePublicationPeer::PUBLICATION_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO "language_publication" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LanguagePublicationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LanguagePublicationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LanguagePublication'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LanguagePublication'][$this->getPrimaryKey()] = true;
        $keys = LanguagePublicationPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LanguagePublicationPeer::ID)) $criteria->add(LanguagePublicationPeer::ID, $this->id);
        if ($this->isColumnModified(LanguagePublicationPeer::LANGUAGE_ID)) $criteria->add(LanguagePublicationPeer::LANGUAGE_ID, $this->language_id);
        if ($this->isColumnModified(LanguagePublicationPeer::PUBLICATION_ID)) $criteria->add(LanguagePublicationPeer::PUBLICATION_ID, $this->publication_id);
        if ($this->isColumnModified(LanguagePublicationPeer::CREATED_AT)) $criteria->add(LanguagePublicationPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(LanguagePublicationPeer::UPDATED_AT)) $criteria->add(LanguagePublicationPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(LanguagePublicationPeer::DATABASE_NAME);
        $criteria->add(LanguagePublicationPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LanguagePublication (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LanguagePublication Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LanguagePublicationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LanguagePublicationPeer();
        }
    ...
    public function getLanguage(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLanguage === null && ($this->language_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aLanguage->addLanguagePublications($this);
             */
        }
    ...
    public function getPublication(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPublication === null && ($this->publication_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPublication->addLanguagePublications($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(LanguagePublicationPeer::DEFAULT_STRING_FORMAT);
    }
