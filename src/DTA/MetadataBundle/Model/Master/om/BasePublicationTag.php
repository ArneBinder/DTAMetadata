...
abstract class BasePublicationTag extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Master\\PublicationTagPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PublicationTagPeer
     */
     ...
     * @return PublicationTag The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PublicationTagPeer::ID;
        }
    ...
    public function setTagId($v)
    {
        ...
        if ($this->tag_id !== $v) {
            $this->tag_id = $v;
            $this->modifiedColumns[] = PublicationTagPeer::TAG_ID;
        }
    ...
    public function setPublicationId($v)
    {
        ...
        if ($this->publication_id !== $v) {
            ...
            $this->modifiedColumns[] = PublicationTagPeer::PUBLICATION_ID;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PublicationTagPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PublicationTagPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = PublicationTagPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PublicationTag object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PublicationTagPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PublicationTagQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PublicationTagPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PublicationTagPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PublicationTagPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PublicationTagPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('publication_tag_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(PublicationTagPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(PublicationTagPeer::TAG_ID)) {
            $modifiedColumns[':p' . $index++]  = '"tag_id"';
        }
        if ($this->isColumnModified(PublicationTagPeer::PUBLICATION_ID)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PublicationTagPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PublicationTagPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PublicationTag'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PublicationTag'][$this->getPrimaryKey()] = true;
        $keys = PublicationTagPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PublicationTagPeer::ID)) $criteria->add(PublicationTagPeer::ID, $this->id);
        if ($this->isColumnModified(PublicationTagPeer::TAG_ID)) $criteria->add(PublicationTagPeer::TAG_ID, $this->tag_id);
        if ($this->isColumnModified(PublicationTagPeer::PUBLICATION_ID)) $criteria->add(PublicationTagPeer::PUBLICATION_ID, $this->publication_id);
        if ($this->isColumnModified(PublicationTagPeer::CREATED_AT)) $criteria->add(PublicationTagPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PublicationTagPeer::UPDATED_AT)) $criteria->add(PublicationTagPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PublicationTagPeer::DATABASE_NAME);
        $criteria->add(PublicationTagPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PublicationTag (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PublicationTag Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PublicationTagPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PublicationTagPeer();
        }
    ...
    {
        return (string) $this->exportTo(PublicationTagPeer::DEFAULT_STRING_FORMAT);
    }
