...
abstract class BaseLanguageWork extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Master\\LanguageWorkPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        LanguageWorkPeer
     */
    ...
    public function setLanguageId($v)
    {
        ...
        if ($this->language_id !== $v) {
            $this->language_id = $v;
            $this->modifiedColumns[] = LanguageWorkPeer::LANGUAGE_ID;
        }
    ...
    public function setWorkId($v)
    {
        ...
        if ($this->work_id !== $v) {
            $this->work_id = $v;
            $this->modifiedColumns[] = LanguageWorkPeer::WORK_ID;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LanguageWorkPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LanguageWorkQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LanguageWorkPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('language_work_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(LanguageWorkPeer::WORK_ID)) {
        ...
        $sql = sprintf(
            'INSERT INTO "language_work" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LanguageWorkPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LanguageWorkPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LanguageWork'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LanguageWork'][$this->getPrimaryKey()] = true;
     ...
     * objects.
     *
     * @param object $copyObj An object of LanguageWork (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LanguageWork Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LanguageWorkPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LanguageWorkPeer();
        }
    ...
    public function getLanguage(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLanguage === null && ($this->language_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aLanguage->addLanguageWorks($this);
             */
        }
    ...
    public function getWork(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aWork === null && ($this->work_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aWork->addLanguageWorks($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(LanguageWorkPeer::DEFAULT_STRING_FORMAT);
    }
