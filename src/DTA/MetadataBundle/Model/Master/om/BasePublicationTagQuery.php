...
abstract class BasePublicationTagQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'dtametadata', $modelName = 'DTA\\MetadataBundle\\Model\\Master\\PublicationTag', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT "tag_id", "publication_id", "id" FROM "publication_tag" WHERE "id" = :p0';
        try {
