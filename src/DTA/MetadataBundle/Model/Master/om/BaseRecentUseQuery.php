 ...
 * @method RecentUseQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method RecentUseQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 ...
 * @method RecentUseQuery groupByCreatedAt() Group by the created_at column
 * @method RecentUseQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 * @method RecentUse findOneByCreatedAt(string $created_at) Return the first RecentUse filtered by the created_at column
 * @method RecentUse findOneByUpdatedAt(string $updated_at) Return the first RecentUse filtered by the updated_at column
 *
 ...
 * @method array findByCreatedAt(string $created_at) Return RecentUse objects filtered by the created_at column
 * @method array findByUpdatedAt(string $updated_at) Return RecentUse objects filtered by the updated_at column
 */
abstract class BaseRecentUseQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "id", "dta_user_id", "publication_id", "date", "created_at", "updated_at" FROM "recent_use" WHERE "id" = :p0';
        try {
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(RecentUsePeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(RecentUsePeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RecentUsePeer::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(RecentUsePeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(RecentUsePeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(RecentUsePeer::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(RecentUsePeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(RecentUsePeer::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(RecentUsePeer::UPDATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(RecentUsePeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(RecentUsePeer::CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(RecentUsePeer::CREATED_AT);
    }
}
