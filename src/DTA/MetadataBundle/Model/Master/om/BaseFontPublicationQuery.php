 ...
 * @method FontPublicationQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method FontPublicationQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 ...
 * @method FontPublicationQuery groupByCreatedAt() Group by the created_at column
 * @method FontPublicationQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 * @method FontPublication findOneByCreatedAt(string $created_at) Return the first FontPublication filtered by the created_at column
 * @method FontPublication findOneByUpdatedAt(string $updated_at) Return the first FontPublication filtered by the updated_at column
 *
 ...
 * @method array findByCreatedAt(string $created_at) Return FontPublication objects filtered by the created_at column
 * @method array findByUpdatedAt(string $updated_at) Return FontPublication objects filtered by the updated_at column
 */
abstract class BaseFontPublicationQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "id", "font_id", "publication_id", "created_at", "updated_at" FROM "font_publication" WHERE "id" = :p0';
        try {
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(FontPublicationPeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(FontPublicationPeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(FontPublicationPeer::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(FontPublicationPeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(FontPublicationPeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(FontPublicationPeer::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(FontPublicationPeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(FontPublicationPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(FontPublicationPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(FontPublicationPeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(FontPublicationPeer::CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(FontPublicationPeer::CREATED_AT);
    }
}
