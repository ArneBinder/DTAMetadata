...
abstract class BasePersonWork extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    ...
    public static $tableRowViewCaptions = array('Id', 'PersonId', 'PersonroleId', 'WorkId', );	public   $tableRowViewAccessors = array('Id'=>'Id', 'PersonId'=>'PersonId', 'PersonroleId'=>'PersonroleId', 'WorkId'=>'WorkId', );
    /**
