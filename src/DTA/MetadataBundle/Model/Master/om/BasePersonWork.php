...
abstract class BasePersonWork extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Master\\PersonWorkPeer';
    ...
    public static $tableRowViewCaptions = array('PersonId', 'PersonroleId', 'WorkId', 'Id', );	public   $tableRowViewAccessors = array('PersonId'=>'PersonId', 'PersonroleId'=>'PersonroleId', 'WorkId'=>'WorkId', 'Id'=>'Id', );
    /**
     ...
     * @return PersonWork The current object (for fluent API support)
     */
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[] = PersonWorkPeer::PERSON_ID;
        }
    ...
    public function setPersonroleId($v)
    {
        ...
        if ($this->personrole_id !== $v) {
            ...
            $this->modifiedColumns[] = PersonWorkPeer::PERSONROLE_ID;
        }
    ...
    public function setWorkId($v)
    {
        ...
        if ($this->work_id !== $v) {
            $this->work_id = $v;
            $this->modifiedColumns[] = PersonWorkPeer::WORK_ID;
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PersonWorkPeer::ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = PersonWorkPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PersonWork object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PersonWorkPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PersonWorkQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PersonWorkPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('person_work_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(PersonWorkPeer::PERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '"person_id"';
        }
        if ($this->isColumnModified(PersonWorkPeer::PERSONROLE_ID)) {
            $modifiedColumns[':p' . $index++]  = '"personrole_id"';
        }
        if ($this->isColumnModified(PersonWorkPeer::WORK_ID)) {
            $modifiedColumns[':p' . $index++]  = '"work_id"';
        }
        if ($this->isColumnModified(PersonWorkPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }

        $sql = sprintf(
            'INSERT INTO "person_work" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PersonWorkPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PersonWorkPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PersonWork'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PersonWork'][$this->getPrimaryKey()] = true;
        $keys = PersonWorkPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PersonWorkPeer::PERSON_ID)) $criteria->add(PersonWorkPeer::PERSON_ID, $this->person_id);
        if ($this->isColumnModified(PersonWorkPeer::PERSONROLE_ID)) $criteria->add(PersonWorkPeer::PERSONROLE_ID, $this->personrole_id);
        if ($this->isColumnModified(PersonWorkPeer::WORK_ID)) $criteria->add(PersonWorkPeer::WORK_ID, $this->work_id);
        if ($this->isColumnModified(PersonWorkPeer::ID)) $criteria->add(PersonWorkPeer::ID, $this->id);
    ...
    {
        $criteria = new Criteria(PersonWorkPeer::DATABASE_NAME);
        $criteria->add(PersonWorkPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PersonWork (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PersonWork Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PersonWorkPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PersonWorkPeer();
        }
    ...
    public function getPerson(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPerson === null && ($this->person_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPerson->addPersonWorks($this);
             */
        }
    ...
    public function getPersonrole(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPersonrole === null && ($this->personrole_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPersonrole->addPersonWorks($this);
             */
        }
    ...
    public function getWork(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aWork === null && ($this->work_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aWork->addPersonWorks($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PersonWorkPeer::DEFAULT_STRING_FORMAT);
    }
