...
abstract class BaseGenreWork extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Master\\GenreWorkPeer';
    ...
    public function setGenreId($v)
    {
        ...
        if ($this->genre_id !== $v) {
            $this->genre_id = $v;
            $this->modifiedColumns[] = GenreWorkPeer::GENRE_ID;
        }
    ...
    public function setWorkId($v)
    {
        ...
        if ($this->work_id !== $v) {
            $this->work_id = $v;
            $this->modifiedColumns[] = GenreWorkPeer::WORK_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = GenreWorkPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating GenreWork object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = GenreWorkPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = GenreWorkQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                GenreWorkPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO "genre_work" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = GenreWorkPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = GenreWorkPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getGenreId()) && (null === $this->getWorkId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of GenreWork (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return GenreWork Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return GenreWorkPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new GenreWorkPeer();
        }
    ...
    public function getGenre(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aGenre === null && ($this->genre_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aGenre->addGenreWorks($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(GenreWorkPeer::DEFAULT_STRING_FORMAT);
    }
