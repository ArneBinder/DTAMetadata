...
/**
 * This class defines the structure of the 'person_work' table.
 *
 *
 *
 ...
 */
class PersonWorkTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.DTA.MetadataBundle.Model.Master.map.PersonWorkTableMap';
