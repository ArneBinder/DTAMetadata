...
/**
 * This class defines the structure of the 'language_work' table.
 *
 *
 *
 ...
 */
class LanguageWorkTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.DTA.MetadataBundle.Model.Master.map.LanguageWorkTableMap';
    ...
    {
        // attributes
        $this->setName('language_work');
        $this->setPhpName('LanguageWork');
        $this->setClassname('DTA\\MetadataBundle\\Model\\Master\\LanguageWork');
        $this->setPackage('src.DTA.MetadataBundle.Model.Master');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('language_work_id_seq');
