...
use DTA\MetadataBundle\Model\HistoricalPerson\PublisherPeer;
use DTA\MetadataBundle\Model\HistoricalPerson\map\PublisherTableMap;
...
abstract class BasePublisherPeer
{
    ...
    const OM_CLASS = 'DTA\\MetadataBundle\\Model\\HistoricalPerson\\Publisher';
    ...
    const PERSON_ID = 'publisher.PERSON_ID';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (PublisherPeer::ID, PublisherPeer::PERSON_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (PublisherPeer::ID => 0, PublisherPeer::PERSON_ID => 1, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PublisherPeer::PERSON_ID);
        } else {
    ...
    public static function doCountJoinPerson(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(PublisherPeer::PERSON_ID, PersonPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Publisher objects pre-filled with their Person objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinPerson(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Publisher) to $obj2 (Person)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Publisher) to the collection in $obj2 (Person)
                $obj2->addPublisher($obj1);
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(PublisherPeer::PERSON_ID);
            $value = $criteria->remove(PublisherPeer::PERSON_ID);
            if ($value) {
                $selectCriteria->add(PublisherPeer::PERSON_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(PublisherPeer::TABLE_NAME);
            }
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(PublisherPeer::ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(PublisherPeer::PERSON_ID, $value[1]));
                $criteria->addOr($criterion);
                // we can invalidate the cache for this single PK
                PublisherPeer::removeInstanceFromPool($value);
            }
        }
    ...
    public static function retrieveByPK($id, $person_id, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $id, (string) $person_id));
         if (null !== ($obj = PublisherPeer::getInstanceFromPool($_instancePoolKey))) {
             return $obj;
        }
        ...
        $criteria = new Criteria(PublisherPeer::DATABASE_NAME);
        $criteria->add(PublisherPeer::ID, $id);
        $criteria->add(PublisherPeer::PERSON_ID, $person_id);
