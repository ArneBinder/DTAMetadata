...
use DTA\MetadataBundle\Model\Classification\map\TagTableMap;
...
abstract class BaseTagPeer
{
    ...
    const OM_CLASS = 'DTA\\MetadataBundle\\Model\\Classification\\Tag';

    /** the related TableMap class for this table */
    const TM_CLASS = 'DTA\\MetadataBundle\\Model\\Classification\\map\\TagTableMap';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (TagPeer::ID, TagPeer::NAME, TagPeer::CREATED_AT, TagPeer::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (TagPeer::ID => 0, TagPeer::NAME => 1, TagPeer::CREATED_AT => 2, TagPeer::UPDATED_AT => 3, ),
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseTagPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \DTA\MetadataBundle\Model\Classification\map\TagTableMap());
      }
    }
