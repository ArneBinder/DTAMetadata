...
abstract class BaseDwdsgenreQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'DTAMetadata', $modelName = 'DTA\\MetadataBundle\\Model\\Classification\\Dwdsgenre', $modelAlias = null)
    {
    ...
    public function useDwdsgenreRelatedByChildofQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'DwdsgenreRelatedByChildof', '\DTA\MetadataBundle\Model\Classification\DwdsgenreQuery');
    }
    ...
    public function useDwdsgenreRelatedByIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'DwdsgenreRelatedById', '\DTA\MetadataBundle\Model\Classification\DwdsgenreQuery');
    }
    ...
    public function useWorkRelatedByDwdsgenreIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'WorkRelatedByDwdsgenreId', '\DTA\MetadataBundle\Model\Publication\WorkQuery');
    }
    ...
    public function useWorkRelatedByDwdssubgenreIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'WorkRelatedByDwdssubgenreId', '\DTA\MetadataBundle\Model\Publication\WorkQuery');
    }
