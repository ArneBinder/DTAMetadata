...
abstract class BaseSourcePeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (SourcePeer::ID, SourcePeer::NAME, SourcePeer::CREATED_AT, SourcePeer::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (SourcePeer::ID => 0, SourcePeer::NAME => 1, SourcePeer::CREATED_AT => 2, SourcePeer::UPDATED_AT => 3, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(SourcePeer::UPDATED_AT);
        } else {
