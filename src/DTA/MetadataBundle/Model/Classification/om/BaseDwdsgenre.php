...
abstract class BaseDwdsgenre extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Classification\\DwdsgenrePeer';
     ...
     * @throws PropelException
     */
    public function getDwdsgenreRelatedByChildof(PropelPDO $con = null)
    {
        if ($this->aDwdsgenreRelatedByChildof === null && ($this->childof !== null)) {
