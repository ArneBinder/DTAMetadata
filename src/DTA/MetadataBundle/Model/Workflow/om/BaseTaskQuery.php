...
abstract class BaseTaskQuery extends ModelCriteria
{
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \DTA\MetadataBundle\Model\Workflow\WritgroupQuery A secondary query class using the current class as primary query
     */
    public function useWritgroupQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinWritgroup($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Writgroup', '\DTA\MetadataBundle\Model\Workflow\WritgroupQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \DTA\MetadataBundle\Model\Workflow\UserQuery A secondary query class using the current class as primary query
     */
    public function useUserQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinUser($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'User', '\DTA\MetadataBundle\Model\Workflow\UserQuery');
    }
