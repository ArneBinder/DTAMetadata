...
abstract class BaseTextsource extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Workflow\\TextsourcePeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = TextsourcePeer::ID;
        }
    ...
    public function setPublicationId($v)
    {
        ...
        if ($this->publication_id !== $v) {
            ...
            $this->modifiedColumns[] = TextsourcePeer::PUBLICATION_ID;
        }
    ...
    public function setPartnerId($v)
    {
        ...
        if ($this->partner_id !== $v) {
            $this->partner_id = $v;
            $this->modifiedColumns[] = TextsourcePeer::PARTNER_ID;
        }
    ...
    public function setLicenseId($v)
    {
        ...
        if ($this->license_id !== $v) {
            $this->license_id = $v;
            $this->modifiedColumns[] = TextsourcePeer::LICENSE_ID;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TextsourcePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TextsourceQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TextsourcePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('textsource_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(TextsourcePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(TextsourcePeer::PUBLICATION_ID)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TextsourcePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TextsourcePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Textsource'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Textsource'][$this->getPrimaryKey()] = true;
        $keys = TextsourcePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    {
        $criteria = new Criteria(TextsourcePeer::DATABASE_NAME);
        $criteria->add(TextsourcePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Textsource (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Textsource Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return TextsourcePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new TextsourcePeer();
        }
    ...
    public function getPublication(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPublication === null && ($this->publication_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPublication->addTextsources($this);
             */
        }
    ...
    public function getLicense(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLicense === null && ($this->license_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLicense->addTextsources($this);
             */
        }
    ...
    public function getPartner(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPartner === null && ($this->partner_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPartner->addTextsources($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(TextsourcePeer::DEFAULT_STRING_FORMAT);
    }
