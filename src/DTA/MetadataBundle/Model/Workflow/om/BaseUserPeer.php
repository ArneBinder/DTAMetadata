...
use DTA\MetadataBundle\Model\Workflow\map\UserTableMap;
...
abstract class BaseUserPeer
{
    ...
    const OM_CLASS = 'DTA\\MetadataBundle\\Model\\Workflow\\User';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Passwordhash', 'NameId', 'Mail', 'Phone', 'Created', 'Modified', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'passwordhash', 'nameId', 'mail', 'phone', 'created', 'modified', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID, UserPeer::USERNAME, UserPeer::PASSWORDHASH, UserPeer::NAME_ID, UserPeer::MAIL, UserPeer::PHONE, UserPeer::CREATED, UserPeer::MODIFIED, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'PASSWORDHASH', 'NAME_ID', 'MAIL', 'PHONE', 'CREATED', 'MODIFIED', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'userName', 'passwordHash', 'name_id', 'mail', 'phone', 'created', 'modified', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Passwordhash' => 2, 'NameId' => 3, 'Mail' => 4, 'Phone' => 5, 'Created' => 6, 'Modified' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'passwordhash' => 2, 'nameId' => 3, 'mail' => 4, 'phone' => 5, 'created' => 6, 'modified' => 7, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::ID => 0, UserPeer::USERNAME => 1, UserPeer::PASSWORDHASH => 2, UserPeer::NAME_ID => 3, UserPeer::MAIL => 4, UserPeer::PHONE => 5, UserPeer::CREATED => 6, UserPeer::MODIFIED => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'PASSWORDHASH' => 2, 'NAME_ID' => 3, 'MAIL' => 4, 'PHONE' => 5, 'CREATED' => 6, 'MODIFIED' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'userName' => 1, 'passwordHash' => 2, 'name_id' => 3, 'mail' => 4, 'phone' => 5, 'created' => 6, 'modified' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserPeer::PASSWORDHASH);
            $criteria->addSelectColumn(UserPeer::NAME_ID);
