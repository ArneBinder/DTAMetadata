...
use DTA\MetadataBundle\Model\Workflow\map\CopyLocationTableMap;

abstract class BaseCopyLocationPeer
{
    ...
    const TABLE_NAME = 'copy_location';
    ...
    const PUBLICATION_ID = 'copy_location.publication_id';

    /** the column name for the partner_id field */
    const PARTNER_ID = 'copy_location.partner_id';

    /** the column name for the catalogue_signature field */
    const CATALOGUE_SIGNATURE = 'copy_location.catalogue_signature';

    /** the column name for the catalogue_internal field */
    const CATALOGUE_INTERNAL = 'copy_location.catalogue_internal';

    /** the column name for the catalogue_url field */
    const CATALOGUE_URL = 'copy_location.catalogue_url';

    /** the column name for the numfaksimiles field */
    const NUMFAKSIMILES = 'copy_location.numfaksimiles';
    ...
    const IMAGEURL = 'copy_location.imageurl';

    /** the column name for the imageurn field */
    const IMAGEURN = 'copy_location.imageurn';
    ...
    const UPDATED_AT = 'copy_location.updated_at';
    ...
    {
        $toNames = CopyLocationPeer::getFieldNames($toType);
        $key = isset(CopyLocationPeer::$fieldKeys[$fromType][$name]) ? CopyLocationPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(CopyLocationPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, CopyLocationPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return CopyLocationPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. CopyLocationPeer::COLUMN_NAME).
     * @return string
     */
    public static function alias($alias, $column)
    {
        return str_replace(CopyLocationPeer::TABLE_NAME.'.', $alias.'.', $column);
    }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CopyLocationPeer::ID);
            $criteria->addSelectColumn(CopyLocationPeer::PUBLICATION_ID);
            $criteria->addSelectColumn(CopyLocationPeer::PARTNER_ID);
            $criteria->addSelectColumn(CopyLocationPeer::CATALOGUE_SIGNATURE);
            $criteria->addSelectColumn(CopyLocationPeer::CATALOGUE_INTERNAL);
            ...
            $criteria->addSelectColumn($alias . '.catalogue_signature');
            $criteria->addSelectColumn($alias . '.catalogue_internal');
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(CopyLocationPeer::TABLE_NAME);
        ...
        $criteria->setDbName(CopyLocationPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectOne(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $critcopy->setLimit(1);
        $objects = CopyLocationPeer::doSelect($critcopy, $con);
        if ($objects) {
            return $objects[0];
        }
    ...
    {
        return CopyLocationPeer::populateObjects(CopyLocationPeer::doSelectStmt($criteria, $con));
    }
    /**
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            CopyLocationPeer::$instances[$key] = $obj;
        }
    }
     ...
     *
     * @param      mixed $value A CopyLocation object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof CopyLocation) {
                $key = (string) $value->getId();
            } elseif (is_scalar($value)) {
                // assume we've been passed a primary key
                $key = (string) $value;
            } else {
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or CopyLocation object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(CopyLocationPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(CopyLocationPeer::$instances[$key])) {
                return CopyLocationPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        ...
        CopyLocationPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to copy_location
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = CopyLocationPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = CopyLocationPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                CopyLocationPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
     ...
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     * @return array (CopyLocation object, last column rank)
     */
    public static function populateObject($row, $startcol = 0)
    {
        $key = CopyLocationPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = CopyLocationPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + CopyLocationPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = CopyLocationPeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doCountJoinPublication(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CopyLocationPeer::PUBLICATION_ID, PublicationPeer::ID, $join_behavior);
    ...
    public static function doCountJoinPartner(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CopyLocationPeer::PARTNER_ID, PartnerPeer::ID, $join_behavior);
    ...
    public static function doCountJoinLicense(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CopyLocationPeer::LICENSE_ID, LicensePeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CopyLocation objects pre-filled with their Publication objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CopyLocation objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinPublication(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CopyLocationPeer::addSelectColumns($criteria);
        $startcol = CopyLocationPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = CopyLocationPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = CopyLocationPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                CopyLocationPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CopyLocation) to $obj2 (Publication)
                $obj2->addCopyLocation($obj1);
    ...
    /**
     * Selects a collection of CopyLocation objects pre-filled with their Partner objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CopyLocation objects.
    ...
    public static function doSelectJoinPartner(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CopyLocation) to $obj2 (Partner)
                $obj2->addCopyLocation($obj1);
    ...
    /**
     * Selects a collection of CopyLocation objects pre-filled with their License objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CopyLocation objects.
    ...
    public static function doSelectJoinLicense(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CopyLocation) to $obj2 (License)
                $obj2->addCopyLocation($obj1);
    ...
    /**
     * Selects a collection of CopyLocation objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CopyLocationPeer::addSelectColumns($criteria);
        $startcol2 = CopyLocationPeer::NUM_HYDRATE_COLUMNS;
        ...
        LicensePeer::addSelectColumns($criteria);
        $startcol5 = $startcol4 + LicensePeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CopyLocation) to the collection in $obj2 (Publication)
                $obj2->addCopyLocation($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (CopyLocation) to the collection in $obj3 (Partner)
                $obj3->addCopyLocation($obj1);
            } // if joined row not null

            // Add objects for joined License rows

            $key4 = LicensePeer::getPrimaryKeyHashFromRow($row, $startcol4);
            if ($key4 !== null) {
                $obj4 = LicensePeer::getInstanceFromPool($key4);
                if (!$obj4) {
                    ...
                    LicensePeer::addInstanceToPool($obj4, $key4);
                } // if obj4 loaded

                // Add the $obj1 (CopyLocation) to the collection in $obj4 (License)
                $obj4->addCopyLocation($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of CopyLocation objects pre-filled with all related objects except Publication.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptPublication(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        PartnerPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + PartnerPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CopyLocationPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (CopyLocation) to the collection in $obj2 (Partner)
                $obj2->addCopyLocation($obj1);
                ...
                // Add the $obj1 (CopyLocation) to the collection in $obj3 (License)
                $obj3->addCopyLocation($obj1);
    ...
    /**
     * Selects a collection of CopyLocation objects pre-filled with all related objects except Partner.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    /**
     * Selects a collection of CopyLocation objects pre-filled with all related objects except License.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    {
        return Propel::getDatabaseMap(CopyLocationPeer::DATABASE_NAME)->getTable(CopyLocationPeer::TABLE_NAME);
    }
    ...
    {
        return CopyLocationPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a CopyLocation or Criteria object.
     *
     * @param      mixed $values Criteria or CopyLocation object containing data that is used to create the INSERT statement.
    ...
    /**
     * Performs an UPDATE on the database, given a CopyLocation or Criteria object.
     *
     * @param      mixed $values Criteria or CopyLocation object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(CopyLocationPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(CopyLocationPeer::ID);
            $value = $criteria->remove(CopyLocationPeer::ID);
            if ($value) {
                $selectCriteria->add(CopyLocationPeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(CopyLocationPeer::TABLE_NAME);
            }

        } else { // $values is CopyLocation object
    ...
    /**
     * Deletes all rows from the copy_location table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(CopyLocationPeer::TABLE_NAME, $con, CopyLocationPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            CopyLocationPeer::clearInstancePool();
            CopyLocationPeer::clearRelatedInstancePool();
            $con->commit();
    ...
    /**
     * Performs a DELETE on the database, given a CopyLocation or Criteria object OR a primary key value.
     *
     * @param      mixed $values Criteria or CopyLocation object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        } elseif ($values instanceof CopyLocation) { // it's a model object
            // invalidate the cache for this single object
            CopyLocationPeer::removeInstanceFromPool($values);
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(CopyLocationPeer::DATABASE_NAME);
            $criteria->add(CopyLocationPeer::ID, (array) $values, Criteria::IN);
            // invalidate the cache for this object(s)
            foreach ((array) $values as $singleval) {
                CopyLocationPeer::removeInstanceFromPool($singleval);
            }
        }
    ...
    /**
     * Validates all modified columns of given CopyLocation object.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        if ($cols) {
            $dbMap = Propel::getDatabaseMap(CopyLocationPeer::DATABASE_NAME);
            $tableMap = $dbMap->getTable(CopyLocationPeer::TABLE_NAME);
        ...
        return BasePeer::doValidate(CopyLocationPeer::DATABASE_NAME, CopyLocationPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = CopyLocationPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(CopyLocationPeer::DATABASE_NAME);
        $criteria->add(CopyLocationPeer::ID, $pk);

        $v = CopyLocationPeer::doSelect($criteria, $con);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(CopyLocationPeer::DATABASE_NAME);
            $criteria->add(CopyLocationPeer::ID, $pks, Criteria::IN);
            $objs = CopyLocationPeer::doSelect($criteria, $con);
        }

        return $objs;
    }

} // BaseCopyLocationPeer

// This is the static code needed to register the TableMap for this table with the main Propel class.
//
BaseCopyLocationPeer::buildTableMap();
