...
abstract class BaseTaskPeer
{
    ...
    const PARTNER_ID = 'task.partner_id';
    ...
    /**
     * Selects a collection of Task objects pre-filled with their Partner objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Task objects.
    ...
    public static function doSelectJoinPartner(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Task) to $obj2 (Partner)
                $obj2->addTask($obj1);
    ...
    public static function doSelectJoinAllExceptTasktype(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = TaskPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (Task) to the collection in $obj4 (Partner)
                $obj4->addTask($obj1);
    ...
    /**
     * Selects a collection of Task objects pre-filled with all related objects except Partner.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
