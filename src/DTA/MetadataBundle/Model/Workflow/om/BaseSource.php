...
use DTA\MetadataBundle\Model\Workflow\SourceQuery;
...
abstract class BaseSource extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Workflow\\SourcePeer';
    ...
    public function setWritId($v)
    {
        ...
        if ($this->writ_id !== $v) {
            $this->writ_id = $v;
            $this->modifiedColumns[] = SourcePeer::WRIT_ID;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SourcePeer::WRIT_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SourcePeer::WRIT_ID)) $criteria->add(SourcePeer::WRIT_ID, $this->writ_id);
