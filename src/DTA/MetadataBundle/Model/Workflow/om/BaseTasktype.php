...
abstract class BaseTasktype extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Workflow\\TasktypePeer';
    ...
    public static $tableRowViewCaptions = array('id', 'Typ', 'Zuordnung', );	public   $tableRowViewAccessors = array('id'=>'Id', 'Typ'=>'Name', 'Zuordnung'=>'accessor:getParent', );	public static $queryConstructionString = NULL;
    /**
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = TasktypePeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = TasktypePeer::NAME;
        }
    ...
    public function setTreeLeft($v)
    {
        ...
        if ($this->tree_left !== $v) {
            $this->tree_left = $v;
            $this->modifiedColumns[] = TasktypePeer::TREE_LEFT;
        }
    ...
    public function setTreeRight($v)
    {
        ...
        if ($this->tree_right !== $v) {
            $this->tree_right = $v;
            $this->modifiedColumns[] = TasktypePeer::TREE_RIGHT;
        }
    ...
    public function setTreeLevel($v)
    {
        ...
        if ($this->tree_level !== $v) {
            $this->tree_level = $v;
            $this->modifiedColumns[] = TasktypePeer::TREE_LEVEL;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = TasktypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TasktypeQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // nested_set behavior
            if ($this->isRoot()) {
                throw new PropelException('Deletion of a root node is disabled for nested sets. Use TasktypePeer::deleteTree() instead to delete an entire tree');
            }
            ...
            if ($ret) {
                ...
                if ($this->isInTree()) {
                    ...
                    TasktypePeer::shiftRLValues(-2, $this->getRightValue() + 1, null, $con);
                }
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                TasktypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TasktypePeer::ID)) {
        ...
        if ($this->isColumnModified(TasktypePeer::TREE_RIGHT)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = TasktypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = TasktypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Tasktype'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Tasktype'][$this->getPrimaryKey()] = true;
        $keys = TasktypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    {
        $criteria = new Criteria(TasktypePeer::DATABASE_NAME);
        $criteria->add(TasktypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Tasktype (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Tasktype Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Tasktype is new, it will return
     ...
     *
     * @param      Tasktype $node Propel node object
     * @return     bool
     */
     ...
     *
     * @param      Tasktype $parent
     * @return     Tasktype The current object, for fluid interface
     */
    ...
    public function getParent(PropelPDO $con = null)
    {
        if ($this->aNestedSetParent === null && $this->hasParent()) {
            $this->aNestedSetParent = TasktypeQuery::create()
                ->ancestorsOf($this)
                ->orderByLevel(true)
                ->findOne($con);
        }
    ...
    {
        if (!TasktypePeer::isValid($this)) {
            return false;
        }

        return TasktypeQuery::create()
    ...
    public function initNestedSetChildren()
    {
        ...
        $this->collNestedSetChildren->setModel('Tasktype');
    }
     ...
     * @return     void
     */
    public function addNestedSetChild($tasktype)
    {
        if ($this->collNestedSetChildren === null) {
            $this->initNestedSetChildren();
        }
        if (!in_array($tasktype, $this->collNestedSetChildren->getArrayCopy(), true)) { // only add it if the **same** object is not already associated
            $this->collNestedSetChildren[]= $tasktype;
     ...
     * @param      PropelPDO $con Connection to use.
     * @return     array     List of Tasktype objects
     */
    public function getChildren($criteria = null, PropelPDO $con = null)
    {
        if (null === $this->collNestedSetChildren || null !== $criteria) {
            if ($this->isLeaf() || ($this->isNew() && null === $this->collNestedSetChildren)) {
                ...
                $collNestedSetChildren = TasktypeQuery::create(null, $criteria)
                  ->childrenOf($this)
                  ->orderByBranch()
                    ->find($con);
                if (null !== $criteria) {
    ...
    public function countChildren($criteria = null, PropelPDO $con = null)
    {
        if (null === $this->collNestedSetChildren || null !== $criteria) {
            if ($this->isLeaf() || ($this->isNew() && null === $this->collNestedSetChildren)) {
                ...
                return TasktypeQuery::create(null, $criteria)
                    ->childrenOf($this)
                    ->count($con);
            }
        } else {
    ...
    public function getFirstChild($query = null, PropelPDO $con = null)
    {
        if ($this->isLeaf()) {
            ...
            return TasktypeQuery::create(null, $query)
                ->childrenOf($this)
                ->orderByBranch()
                ->findOne($con);
        }
    ...
    public function getSiblings($includeNode = false, $query = null, PropelPDO $con = null)
    {
        if ($this->isRoot()) {
            return array();
             ...
             $query = TasktypeQuery::create(null, $query)
     ...
     *
     * @param      Tasktype $child	Propel object for child node
     *
     * @return     Tasktype The current Propel object
     */
    public function addChild(Tasktype $child)
    {
        if ($this->isNew()) {
            throw new PropelException('A Tasktype object must not be new to accept children.');
        }
     ...
     *
     * @param      Tasktype $parent	Propel object for parent node
     *
     * @return     Tasktype The current Propel object
     */
    ...
    {
        if ($this->isInTree()) {
            throw new PropelException('A Tasktype object must not already be in the tree to be inserted. Use the moveToFirstChildOf() instead.');
        }
        ...
        $this->nestedSetQueries []= array(
            'callable'  => array('\\DTA\MetadataBundle\Model\Workflow\\TasktypePeer', 'makeRoomForLeaf'),
    ...
    {
        if ($this->isInTree()) {
            throw new PropelException('A Tasktype object must not already be in the tree to be inserted. Use the moveToLastChildOf() instead.');
        }
     ...
     * are not persisted until the current object is saved.
     *
     * @param      Tasktype $sibling	Propel object for parent node
     *
     * @return     Tasktype The current Propel object
     */
    ...
    {
        if ($this->isInTree()) {
            throw new PropelException('A Tasktype object must not already be in the tree to be inserted. Use the moveToPrevSiblingOf() instead.');
        }
    ...
    {
        if ($this->isInTree()) {
            throw new PropelException('A Tasktype object must not already be in the tree to be inserted. Use the moveToNextSiblingOf() instead.');
        }
    ...
    {
        if (!$this->isInTree()) {
            throw new PropelException('A Tasktype object must be already in the tree to be moved. Use the insertAsFirstChildOf() instead.');
        }
    ...
    {
        if (!$this->isInTree()) {
            throw new PropelException('A Tasktype object must be already in the tree to be moved. Use the insertAsLastChildOf() instead.');
        }
        if ($parent->isDescendantOf($this)) {
            throw new PropelException('Cannot move a node as child of one of its subtree nodes.');
        }
     ...
     * The modifications in the current object and the tree are immediate
     *
     * @param      Tasktype $sibling	Propel object for sibling node
     * @param      PropelPDO $con	Connection to use.
     *
     * @return     Tasktype The current Propel object
     */
    ...
    {
        if (!$this->isInTree()) {
            throw new PropelException('A Tasktype object must be already in the tree to be moved. Use the insertAsPrevSiblingOf() instead.');
        }
        if ($sibling->isRoot()) {
    ...
    {
        if (!$this->isInTree()) {
            throw new PropelException('A Tasktype object must be already in the tree to be moved. Use the insertAsNextSiblingOf() instead.');
        }
        if ($sibling->isRoot()) {
    ...
    protected function moveSubtreeTo($destLeft, $levelDelta, PropelPDO $con = null)
    {
        ...
        try {
            ...
            TasktypePeer::shiftRLValues($treeSize, $destLeft, null, $con);
            ...
            if (!$preventDefault) {
                ...
                if ($levelDelta) {
                    ...
                    TasktypePeer::shiftLevel($levelDelta, $left, $right, $con);
                }

                // move the subtree to the target
                TasktypePeer::shiftRLValues($destLeft - $left, $left, $right, $con);
            }

            // remove the empty room at the previous location of the subtree
            TasktypePeer::shiftRLValues(-$treeSize, $right + 1, null, $con);

            // update all loaded nodes
            TasktypePeer::updateLoadedNodes(null, $con);
     ...
     * so existing Tasktype instances are probably invalid (except for the current one)
     *
     * @param      PropelPDO $con Connection to use.
     *
    ...
    public function deleteDescendants(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $ret = TasktypeQuery::create()
                ->descendantsOf($this)
                ->delete($con);

            // fill up the room that was used by descendants
            TasktypePeer::shiftRLValues($left - $right + 1, $right, null, $con);
