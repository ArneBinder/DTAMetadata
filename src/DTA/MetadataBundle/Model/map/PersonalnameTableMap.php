...
class PersonalnameTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.DTA.MetadataBundle.Model.map.PersonalnameTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('DTA\\MetadataBundle\\Model\\Personalname');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Namefragment', 'DTA\\MetadataBundle\\Model\\Namefragment', RelationMap::ONE_TO_MANY, array('id' => 'personalName_id', ), null, null, 'Namefragments');
    } // buildRelations()
