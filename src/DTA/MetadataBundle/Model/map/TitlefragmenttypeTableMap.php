...
class TitlefragmenttypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.DTA.MetadataBundle.Model.map.TitlefragmenttypeTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('DTA\\MetadataBundle\\Model\\Titlefragmenttype');
    ...
    {
        $this->addRelation('Titlefragment', 'DTA\\MetadataBundle\\Model\\Titlefragment', RelationMap::ONE_TO_MANY, array('id' => 'titleFragmentType_id', ), null, null, 'Titlefragments');
    } // buildRelations()
