...
class NamefragmenttypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.DTA.MetadataBundle.Model.map.NamefragmenttypeTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('DTA\\MetadataBundle\\Model\\Namefragmenttype');
    ...
    {
        $this->addRelation('Namefragment', 'DTA\\MetadataBundle\\Model\\Namefragment', RelationMap::ONE_TO_MANY, array('id' => 'nameFragmentTypeId', ), null, null, 'Namefragments');
    } // buildRelations()
