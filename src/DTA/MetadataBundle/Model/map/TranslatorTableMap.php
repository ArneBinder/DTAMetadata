...
/**
 * This class defines the structure of the 'translator' table.
 *
 *
 *
...
class TranslatorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.DTA.MetadataBundle.Model.map.TranslatorTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('DTA\\MetadataBundle\\Model\\Translator');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('Monograph', 'DTA\\MetadataBundle\\Model\\Monograph', RelationMap::ONE_TO_MANY, array('id' => 'translator_id', ), null, null, 'Monographs');
