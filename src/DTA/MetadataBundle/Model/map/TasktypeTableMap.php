...
class TasktypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'src.DTA.MetadataBundle.Model.map.TasktypeTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setClassname('DTA\\MetadataBundle\\Model\\Tasktype');
    ...
    {
        $this->addRelation('Task', 'DTA\\MetadataBundle\\Model\\Task', RelationMap::ONE_TO_MANY, array('id' => 'taskType_id', ), null, null, 'Tasks');
    } // buildRelations()
