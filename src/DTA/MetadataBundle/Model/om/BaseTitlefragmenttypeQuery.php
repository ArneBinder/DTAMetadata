...
use DTA\MetadataBundle\Model\TitlefragmenttypeQuery;
...
abstract class BaseTitlefragmenttypeQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'DTAMetadata', $modelName = 'DTA\\MetadataBundle\\Model\\Titlefragmenttype', $modelAlias = null)
    {
