...
abstract class BaseTranslator extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\TranslatorPeer';
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[] = TranslatorPeer::PERSON_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = TranslatorPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = TranslatorQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(TranslatorPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(TranslatorPeer::PERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`person_id`';
        }

        $sql = sprintf(
            'INSERT INTO `translator` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['Translator'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Translator'][serialize($this->getPrimaryKey())] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TranslatorPeer::PERSON_ID)) $criteria->add(TranslatorPeer::PERSON_ID, $this->person_id);
    ...
    public function buildPkeyCriteria()
    {
        ...
        $criteria->add(TranslatorPeer::PERSON_ID, $this->person_id);
    ...
    public function getPerson(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPerson === null && ($this->person_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPerson->addTranslators($this);
             */
        }
     ...
     * If this Translator is new, it will return
    ...
    public function setPublications(PropelCollection $publications, PropelPDO $con = null)
    {
        ...
        foreach ($publicationsToDelete as $publicationRemoved) {
            $publicationRemoved->setTranslator(null);
        }
    ...
    protected function doAddPublication($publication)
    {
        ...
        $publication->setTranslator($this);
    }
    ...
    public function removePublication($publication)
    {
        if ($this->getPublications()->contains($publication)) {
            ...
            $publication->setTranslator(null);
        }
    ...
    public function setMonographs(PropelCollection $monographs, PropelPDO $con = null)
    {
        ...
        foreach ($monographsToDelete as $monographRemoved) {
            $monographRemoved->setTranslator(null);
        }
    ...
    public function setEssays(PropelCollection $essays, PropelPDO $con = null)
    {
        ...
        foreach ($essaysToDelete as $essayRemoved) {
            $essayRemoved->setTranslator(null);
        }
    ...
    public function setMagazines(PropelCollection $magazines, PropelPDO $con = null)
    {
        ...
        foreach ($magazinesToDelete as $magazineRemoved) {
            $magazineRemoved->setTranslator(null);
        }
    ...
    public function setSeries(PropelCollection $series, PropelPDO $con = null)
    {
        ...
        foreach ($seriesToDelete as $seriesRemoved) {
            $seriesRemoved->setTranslator(null);
        }
    ...
    {
        return (string) $this->exportTo(TranslatorPeer::DEFAULT_STRING_FORMAT);
    }
