...
abstract class BaseGenreQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'DTAMetadata', $modelName = 'DTA\\MetadataBundle\\Model\\Genre', $modelAlias = null)
    {
    ...
    public function useGenreRelatedByChildofQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'GenreRelatedByChildof', '\DTA\MetadataBundle\Model\GenreQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByWorkRelatedByGenreId($work, $comparison = null)
    {
        if ($work instanceof Work) {
            return $this
                ->addUsingAlias(GenrePeer::ID, $work->getGenreId(), $comparison);
        } elseif ($work instanceof PropelObjectCollection) {
            return $this
                ->useWorkRelatedByGenreIdQuery()
                ->filterByPrimaryKeys($work->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByWorkRelatedByGenreId() only accepts arguments of type Work or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the WorkRelatedByGenreId relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return GenreQuery The current query, for fluid interface
     */
    public function joinWorkRelatedByGenreId($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('WorkRelatedByGenreId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'WorkRelatedByGenreId');
        }
    ...
    /**
     * Use the WorkRelatedByGenreId relation Work object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useWorkRelatedByGenreIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinWorkRelatedByGenreId($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'WorkRelatedByGenreId', '\DTA\MetadataBundle\Model\WorkQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByWorkRelatedBySubgenreId($work, $comparison = null)
    {
        if ($work instanceof Work) {
            return $this
                ->addUsingAlias(GenrePeer::ID, $work->getSubgenreId(), $comparison);
        } elseif ($work instanceof PropelObjectCollection) {
            return $this
                ->useWorkRelatedBySubgenreIdQuery()
                ->filterByPrimaryKeys($work->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByWorkRelatedBySubgenreId() only accepts arguments of type Work or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the WorkRelatedBySubgenreId relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return GenreQuery The current query, for fluid interface
     */
    public function joinWorkRelatedBySubgenreId($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('WorkRelatedBySubgenreId');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'WorkRelatedBySubgenreId');
        }
    ...
    /**
     * Use the WorkRelatedBySubgenreId relation Work object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   \DTA\MetadataBundle\Model\WorkQuery A secondary query class using the current class as primary query
     */
    public function useWorkRelatedBySubgenreIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
