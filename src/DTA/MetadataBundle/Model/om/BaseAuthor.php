...
abstract class BaseAuthor extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\AuthorPeer';
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[] = AuthorPeer::PERSON_ID;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AuthorPeer::PERSON_ID)) {
    ...
    {
        if (isset($alreadyDumpedObjects['Author'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Author'][serialize($this->getPrimaryKey())] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AuthorPeer::PERSON_ID)) $criteria->add(AuthorPeer::PERSON_ID, $this->person_id);
    ...
    public function buildPkeyCriteria()
    {
        ...
        $criteria->add(AuthorPeer::PERSON_ID, $this->person_id);
     ...
     * @return PropelObjectCollection|AuthorWork[] List of AuthorWork objects
     */
    public function getAuthorWorksJoinWork($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = AuthorWorkQuery::create(null, $criteria);
     ...
     *
     * @param  Work $work The AuthorWork object to relate
     * @return Author The current object (for fluent API support)
     */
