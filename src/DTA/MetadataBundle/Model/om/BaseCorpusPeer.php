...
use DTA\MetadataBundle\Model\map\CorpusTableMap;
...
abstract class BaseCorpusPeer
{
    ...
    const OM_CLASS = 'DTA\\MetadataBundle\\Model\\Corpus';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'WritId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'writId', ),
        BasePeer::TYPE_COLNAME => array (CorpusPeer::ID, CorpusPeer::NAME, CorpusPeer::WRIT_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'WRIT_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'writ_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'WritId' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'writId' => 2, ),
        BasePeer::TYPE_COLNAME => array (CorpusPeer::ID => 0, CorpusPeer::NAME => 1, CorpusPeer::WRIT_ID => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'WRIT_ID' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'writ_id' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CorpusPeer::WRIT_ID);
        } else {
    ...
    public static function doCountJoinWrit(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CorpusPeer::WRIT_ID, WritPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Corpus objects pre-filled with their Writ objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of Corpus objects.
     * @throws PropelException Any exceptions caught during processing will be
     *		 rethrown wrapped into a PropelException.
     */
    public static function doSelectJoinWrit(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CorpusPeer::addSelectColumns($criteria);
        $startcol = CorpusPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = CorpusPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = CorpusPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                CorpusPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Corpus) to $obj2 (Writ)
                $obj2->addCorpus($obj1);
    ...
    /**
     * Selects a collection of Corpus objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        CorpusPeer::addSelectColumns($criteria);
        $startcol2 = CorpusPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Corpus) to the collection in $obj2 (Writ)
                $obj2->addCorpus($obj1);
