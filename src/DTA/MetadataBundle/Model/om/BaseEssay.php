...
abstract class BaseEssay extends Publication implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\EssayPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = EssayPeer::ID;
        }
    ...
    public function setPrintrun($v)
    {
        ...
        if ($this->printrun !== $v) {
            $this->printrun = $v;
            $this->modifiedColumns[] = EssayPeer::PRINTRUN;
        }
    ...
    public function setEdition($v)
    {
        ...
        if ($this->edition !== $v) {
            $this->edition = $v;
            $this->modifiedColumns[] = EssayPeer::EDITION;
        }
    ...
    public function setEditionnumerical($v)
    {
        ...
        if ($this->editionnumerical !== $v) {
            ...
            $this->modifiedColumns[] = EssayPeer::EDITIONNUMERICAL;
        }
    ...
    public function setNumpages($v)
    {
        ...
        if ($this->numpages !== $v) {
            $this->numpages = $v;
            $this->modifiedColumns[] = EssayPeer::NUMPAGES;
        }
    ...
    public function setNumpagesnormed($v)
    {
        ...
        if ($this->numpagesnormed !== $v) {
            ...
            $this->modifiedColumns[] = EssayPeer::NUMPAGESNORMED;
        }
    ...
    public function setBibliographiccitation($v)
    {
        ...
        if ($this->bibliographiccitation !== $v) {
            ...
            $this->modifiedColumns[] = EssayPeer::BIBLIOGRAPHICCITATION;
        }
    ...
    public function setPublicationdateId($v)
    {
        ...
        if ($this->publicationdate_id !== $v) {
            ...
            $this->modifiedColumns[] = EssayPeer::PUBLICATIONDATE_ID;
        }
    ...
    public function setOrigindateId($v)
    {
        ...
        if ($this->origindate_id !== $v) {
            ...
            $this->modifiedColumns[] = EssayPeer::ORIGINDATE_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 17; // 17 = EssayPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EssayPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                EssayPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EssayPeer::EDITION)) {
            $modifiedColumns[':p' . $index++]  = '`edition`';
        }
        if ($this->isColumnModified(EssayPeer::EDITIONNUMERICAL)) {
            $modifiedColumns[':p' . $index++]  = '`editionNumerical`';
        }
        if ($this->isColumnModified(EssayPeer::NUMPAGES)) {
            $modifiedColumns[':p' . $index++]  = '`numPages`';
        }
        if ($this->isColumnModified(EssayPeer::NUMPAGESNORMED)) {
        ...
        if ($this->isColumnModified(EssayPeer::PUBLICATIONDATE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`publicationDate_id`';
        }
        if ($this->isColumnModified(EssayPeer::ORIGINDATE_ID)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EssayPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EssayPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EssayPeer::EDITIONNUMERICAL)) $criteria->add(EssayPeer::EDITIONNUMERICAL, $this->editionnumerical);
        ...
        if ($this->isColumnModified(EssayPeer::PUBLICATIONDATE_ID)) $criteria->add(EssayPeer::PUBLICATIONDATE_ID, $this->publicationdate_id);
        if ($this->isColumnModified(EssayPeer::ORIGINDATE_ID)) $criteria->add(EssayPeer::ORIGINDATE_ID, $this->origindate_id);
    ...
    {
        $criteria = new Criteria(EssayPeer::DATABASE_NAME);
        $criteria->add(EssayPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Essay (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Essay Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPublishingcompany(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPublishingcompany === null && ($this->publishingcompany_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPublishingcompany->addEssays($this);
             */
        }
    ...
    public function setDatespecificationRelatedByPublicationdateId(Datespecification $v = null)
    {
        ...
        if ($v !== null) {
            $v->addEssayRelatedByPublicationdateId($this);
        }
    ...
    public function getDatespecificationRelatedByPublicationdateId(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDatespecificationRelatedByPublicationdateId === null && ($this->publicationdate_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDatespecificationRelatedByPublicationdateId->addEssaysRelatedByPublicationdateId($this);
             */
        }
    ...
    public function setDatespecificationRelatedByOrigindateId(Datespecification $v = null)
    {
        ...
        // If this object has already been added to the Datespecification object, it will not be re-added.
        if ($v !== null) {
            $v->addEssayRelatedByOrigindateId($this);
        }
    ...
    public function getDatespecificationRelatedByOrigindateId(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDatespecificationRelatedByOrigindateId === null && ($this->origindate_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDatespecificationRelatedByOrigindateId->addEssaysRelatedByOrigindateId($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(EssayPeer::DEFAULT_STRING_FORMAT);
    }
