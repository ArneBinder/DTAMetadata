...
abstract class BaseRelatedset extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\RelatedsetPeer';
     ...
     * @return Relatedset The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RelatedsetPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = RelatedsetPeer::NAME;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = RelatedsetPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Relatedset object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RelatedsetPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RelatedsetQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RelatedsetPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RelatedsetPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RelatedsetPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }

        $sql = sprintf(
            'INSERT INTO `relatedSet` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RelatedsetPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RelatedsetPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Relatedset'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Relatedset'][$this->getPrimaryKey()] = true;
        $keys = RelatedsetPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RelatedsetPeer::ID)) $criteria->add(RelatedsetPeer::ID, $this->id);
        if ($this->isColumnModified(RelatedsetPeer::NAME)) $criteria->add(RelatedsetPeer::NAME, $this->name);
    ...
    {
        $criteria = new Criteria(RelatedsetPeer::DATABASE_NAME);
        $criteria->add(RelatedsetPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Relatedset (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Relatedset Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RelatedsetPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RelatedsetPeer();
        }
     ...
     * If this Relatedset is new, it will return
    ...
    public function setPublications(PropelCollection $publications, PropelPDO $con = null)
    {
        ...
        foreach ($publicationsToDelete as $publicationRemoved) {
            $publicationRemoved->setRelatedset(null);
        }
    ...
    protected function doAddPublication($publication)
    {
        ...
        $publication->setRelatedset($this);
    }
    ...
    public function removePublication($publication)
    {
        if ($this->getPublications()->contains($publication)) {
            ...
            $publication->setRelatedset(null);
        }
     ...
     * Otherwise if this Relatedset is new, it will return
     * an empty collection; or if this Relatedset has previously
     * been saved, it will retrieve related Publications from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Relatedset.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setMonographs(PropelCollection $monographs, PropelPDO $con = null)
    {
        ...
        foreach ($monographsToDelete as $monographRemoved) {
            $monographRemoved->setRelatedset(null);
        }
    ...
    public function setEssays(PropelCollection $essays, PropelPDO $con = null)
    {
        ...
        foreach ($essaysToDelete as $essayRemoved) {
            $essayRemoved->setRelatedset(null);
        }
    ...
    public function setMagazines(PropelCollection $magazines, PropelPDO $con = null)
    {
        ...
        foreach ($magazinesToDelete as $magazineRemoved) {
            $magazineRemoved->setRelatedset(null);
        }
    ...
    public function setSeries(PropelCollection $series, PropelPDO $con = null)
    {
        ...
        foreach ($seriesToDelete as $seriesRemoved) {
            $seriesRemoved->setRelatedset(null);
        }
    ...
    {
        return (string) $this->exportTo(RelatedsetPeer::DEFAULT_STRING_FORMAT);
    }
