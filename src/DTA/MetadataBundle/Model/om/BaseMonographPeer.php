...
abstract class BaseMonographPeer extends PublicationPeer
{
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = MonographPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
        ...
        $criteria = new Criteria(MonographPeer::DATABASE_NAME);
        $criteria->add(MonographPeer::ID, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(MonographPeer::DATABASE_NAME);
            $criteria->add(MonographPeer::ID, $pks, Criteria::IN);
            $objs = MonographPeer::doSelect($criteria, $con);
        }
