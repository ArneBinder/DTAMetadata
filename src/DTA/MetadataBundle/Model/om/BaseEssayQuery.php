 ...
 * @method EssayQuery orderByPublicationId($order = Criteria::ASC) Order by the publication_id column
 *
 * @method EssayQuery groupById() Group by the id column
 * @method EssayQuery groupByPublicationId() Group by the publication_id column
 *
 ...
 *
 * @method Essay findOneById(int $id) Return the first Essay filtered by the id column
 * @method Essay findOneByPublicationId(int $publication_id) Return the first Essay filtered by the publication_id column
 *
 * @method array findById(int $id) Return Essay objects filtered by the id column
 * @method array findByPublicationId(int $publication_id) Return Essay objects filtered by the publication_id column
 */
abstract class BaseEssayQuery extends ModelCriteria
{
    ...
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = EssayPeer::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1]))))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT `id`, `publication_id` FROM `essay` WHERE `id` = :p0 AND `publication_id` = :p1';
        try {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $obj = new Essay();
            $obj->hydrate($row);
            EssayPeer::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1])));
        }
        $stmt->closeCursor();
    ...
    {
        $this->addUsingAlias(EssayPeer::ID, $key[0], Criteria::EQUAL);
        $this->addUsingAlias(EssayPeer::PUBLICATION_ID, $key[1], Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        foreach ($keys as $key) {
            $cton0 = $this->getNewCriterion(EssayPeer::ID, $key[0], Criteria::EQUAL);
            $cton1 = $this->getNewCriterion(EssayPeer::PUBLICATION_ID, $key[1], Criteria::EQUAL);
            $cton0->addAnd($cton1);
            $this->addOr($cton0);
        }
    ...
    public function filterByPublicationId($publicationId = null, $comparison = null)
    {
        if (is_array($publicationId)) {
            ...
            if (isset($publicationId['min'])) {
                $this->addUsingAlias(EssayPeer::PUBLICATION_ID, $publicationId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($publicationId['max'])) {
                $this->addUsingAlias(EssayPeer::PUBLICATION_ID, $publicationId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(EssayPeer::PUBLICATION_ID, $publicationId, $comparison);
    }
    ...
    public function filterByPublication($publication, $comparison = null)
    {
        if ($publication instanceof Publication) {
            return $this
                ->addUsingAlias(EssayPeer::PUBLICATION_ID, $publication->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(EssayPeer::PUBLICATION_ID, $publication->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    {
        if ($essay) {
            $this->addCond('pruneCond0', $this->getAliasedColName(EssayPeer::ID), $essay->getId(), Criteria::NOT_EQUAL);
            $this->addCond('pruneCond1', $this->getAliasedColName(EssayPeer::PUBLICATION_ID), $essay->getPublicationId(), Criteria::NOT_EQUAL);
