...
abstract class BasePrinter extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\PrinterPeer';
     ...
     * @return Printer The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PrinterPeer::ID;
        }
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[] = PrinterPeer::PERSON_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = PrinterPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Printer object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PrinterPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PrinterQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PrinterPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PrinterPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(PrinterPeer::PERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '`person_id`';
        }

        $sql = sprintf(
            'INSERT INTO `printer` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PrinterPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PrinterPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Printer'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Printer'][serialize($this->getPrimaryKey())] = true;
        $keys = PrinterPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PrinterPeer::ID)) $criteria->add(PrinterPeer::ID, $this->id);
        if ($this->isColumnModified(PrinterPeer::PERSON_ID)) $criteria->add(PrinterPeer::PERSON_ID, $this->person_id);
    ...
    {
        $criteria = new Criteria(PrinterPeer::DATABASE_NAME);
        $criteria->add(PrinterPeer::ID, $this->id);
        $criteria->add(PrinterPeer::PERSON_ID, $this->person_id);
     ...
     * If this Printer is new, it will return
    ...
    public function setPublications(PropelCollection $publications, PropelPDO $con = null)
    {
        ...
        foreach ($publicationsToDelete as $publicationRemoved) {
            $publicationRemoved->setPrinter(null);
        }
     ...
     * Otherwise if this Printer is new, it will return
     * an empty collection; or if this Printer has previously
     * been saved, it will retrieve related Publications from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Printer.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setMonographs(PropelCollection $monographs, PropelPDO $con = null)
    {
        ...
        foreach ($monographsToDelete as $monographRemoved) {
            $monographRemoved->setPrinter(null);
        }
    ...
    public function setMagazines(PropelCollection $magazines, PropelPDO $con = null)
    {
        ...
        foreach ($magazinesToDelete as $magazineRemoved) {
            $magazineRemoved->setPrinter(null);
        }
    ...
    {
        return (string) $this->exportTo(PrinterPeer::DEFAULT_STRING_FORMAT);
    }
