...
use DTA\MetadataBundle\Model\Publication\map\VolumeTableMap;
...
abstract class BaseVolumePeer
{
    ...
    const OM_CLASS = 'DTA\\MetadataBundle\\Model\\Publication\\Volume';
    ...
    /** the column name for the VOLUMEINDEX field */
    const VOLUMEINDEX = 'volume.VOLUMEINDEX';

    /** the column name for the VOLUMEINDEXNUMERICAL field */
    const VOLUMEINDEXNUMERICAL = 'volume.VOLUMEINDEXNUMERICAL';

    /** the column name for the TOTALVOLUMES field */
    const TOTALVOLUMES = 'volume.TOTALVOLUMES';

    /** the column name for the MONOGRAPH_ID field */
    const MONOGRAPH_ID = 'volume.MONOGRAPH_ID';

    /** the column name for the MONOGRAPH_PUBLICATION_ID field */
    const MONOGRAPH_PUBLICATION_ID = 'volume.MONOGRAPH_PUBLICATION_ID';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Volumeindex', 'Volumeindexnumerical', 'Totalvolumes', 'MonographId', 'MonographPublicationId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'volumeindex', 'volumeindexnumerical', 'totalvolumes', 'monographId', 'monographPublicationId', ),
        BasePeer::TYPE_COLNAME => array (VolumePeer::ID, VolumePeer::VOLUMEINDEX, VolumePeer::VOLUMEINDEXNUMERICAL, VolumePeer::TOTALVOLUMES, VolumePeer::MONOGRAPH_ID, VolumePeer::MONOGRAPH_PUBLICATION_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'VOLUMEINDEX', 'VOLUMEINDEXNUMERICAL', 'TOTALVOLUMES', 'MONOGRAPH_ID', 'MONOGRAPH_PUBLICATION_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'volumeIndex', 'volumeIndexNumerical', 'totalVolumes', 'monograph_id', 'monograph_publication_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Volumeindex' => 1, 'Volumeindexnumerical' => 2, 'Totalvolumes' => 3, 'MonographId' => 4, 'MonographPublicationId' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'volumeindex' => 1, 'volumeindexnumerical' => 2, 'totalvolumes' => 3, 'monographId' => 4, 'monographPublicationId' => 5, ),
        BasePeer::TYPE_COLNAME => array (VolumePeer::ID => 0, VolumePeer::VOLUMEINDEX => 1, VolumePeer::VOLUMEINDEXNUMERICAL => 2, VolumePeer::TOTALVOLUMES => 3, VolumePeer::MONOGRAPH_ID => 4, VolumePeer::MONOGRAPH_PUBLICATION_ID => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'VOLUMEINDEX' => 1, 'VOLUMEINDEXNUMERICAL' => 2, 'TOTALVOLUMES' => 3, 'MONOGRAPH_ID' => 4, 'MONOGRAPH_PUBLICATION_ID' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'volumeIndex' => 1, 'volumeIndexNumerical' => 2, 'totalVolumes' => 3, 'monograph_id' => 4, 'monograph_publication_id' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(VolumePeer::VOLUMEINDEX);
            $criteria->addSelectColumn(VolumePeer::VOLUMEINDEXNUMERICAL);
            $criteria->addSelectColumn(VolumePeer::TOTALVOLUMES);
            $criteria->addSelectColumn(VolumePeer::MONOGRAPH_ID);
            $criteria->addSelectColumn(VolumePeer::MONOGRAPH_PUBLICATION_ID);
        } else {
            $criteria->addSelectColumn($alias . '.ID');
            $criteria->addSelectColumn($alias . '.VOLUMEINDEX');
            $criteria->addSelectColumn($alias . '.VOLUMEINDEXNUMERICAL');
            $criteria->addSelectColumn($alias . '.TOTALVOLUMES');
            $criteria->addSelectColumn($alias . '.MONOGRAPH_ID');
            $criteria->addSelectColumn($alias . '.MONOGRAPH_PUBLICATION_ID');
        }
    }
    ...
    /**
     * Selects a collection of Volume objects pre-filled with their Monograph objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinMonograph(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Volume) to $obj2 (Monograph)
                $obj2->addVolume($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key2 = MonographPeer::getPrimaryKeyHashFromRow($row, $startcol2);
            if ($key2 !== null) {
                $obj2 = MonographPeer::getInstanceFromPool($key2);
                if (!$obj2) {
                ...
                // Add the $obj1 (Volume) to the collection in $obj2 (Monograph)
                $obj2->addVolume($obj1);
