...
use DTA\MetadataBundle\Model\Publication\map\PublishingcompanyTableMap;
...
abstract class BasePublishingcompanyPeer
{
    ...
    const OM_CLASS = 'DTA\\MetadataBundle\\Model\\Publication\\Publishingcompany';

    /** the related TableMap class for this table */
    const TM_CLASS = 'PublishingcompanyTableMap';
    ...
    /**
     * An identiy map to hold any loaded instances of Publishingcompany objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (PublishingcompanyPeer::ID, PublishingcompanyPeer::NAME, PublishingcompanyPeer::GND, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (PublishingcompanyPeer::ID => 0, PublishingcompanyPeer::NAME => 1, PublishingcompanyPeer::GND => 2, ),
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePublishingcompanyPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new PublishingcompanyTableMap());
      }
    }
