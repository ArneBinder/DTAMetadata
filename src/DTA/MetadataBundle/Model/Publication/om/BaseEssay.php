...
abstract class BaseEssay extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Publication\\EssayPeer';
    ...
    public function setPublicationId($v)
    {
        ...
        if ($this->publication_id !== $v) {
            ...
            $this->modifiedColumns[] = EssayPeer::PUBLICATION_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = EssayPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EssayPeer::PUBLICATION_ID)) {
    ...
    {
        if (isset($alreadyDumpedObjects['Essay'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Essay'][serialize($this->getPrimaryKey())] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EssayPeer::PUBLICATION_ID)) $criteria->add(EssayPeer::PUBLICATION_ID, $this->publication_id);
    ...
    public function buildPkeyCriteria()
    {
        ...
        $criteria->add(EssayPeer::PUBLICATION_ID, $this->publication_id);
    ...
    public function getPublication(PropelPDO $con = null)
    {
        if ($this->aPublication === null && ($this->publication_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPublication->addEssays($this);
             */
        }
