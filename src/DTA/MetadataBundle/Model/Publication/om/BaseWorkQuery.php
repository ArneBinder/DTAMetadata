...
abstract class BaseWorkQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'DTAMetadata', $modelName = 'DTA\\MetadataBundle\\Model\\Publication\\Work', $modelAlias = null)
    {
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \DTA\MetadataBundle\Model\Workflow\StatusQuery A secondary query class using the current class as primary query
     */
    public function useStatusQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinStatus($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Status', '\DTA\MetadataBundle\Model\Workflow\StatusQuery');
    }
    ...
    public function useGenreRelatedByGenreIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'GenreRelatedByGenreId', '\DTA\MetadataBundle\Model\Classification\GenreQuery');
    }
    ...
    public function useGenreRelatedBySubgenreIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'GenreRelatedBySubgenreId', '\DTA\MetadataBundle\Model\Classification\GenreQuery');
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \DTA\MetadataBundle\Model\Classification\DwdsgenreQuery A secondary query class using the current class as primary query
     */
    public function useDwdsgenreRelatedByDwdsgenreIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'DwdsgenreRelatedByDwdsgenreId', '\DTA\MetadataBundle\Model\Classification\DwdsgenreQuery');
    }
    ...
    public function useDwdsgenreRelatedByDwdssubgenreIdQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'DwdsgenreRelatedByDwdssubgenreId', '\DTA\MetadataBundle\Model\Classification\DwdsgenreQuery');
    }
