...
abstract class BaseWrit extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Publication\\WritPeer';
     ...
     * @throws PropelException
     */
    public function getPrinter(PropelPDO $con = null)
    {
        if ($this->aPrinter === null && ($this->printer_id !== null)) {
     ...
     * @throws PropelException
     */
    public function getRelatedset(PropelPDO $con = null)
    {
        if ($this->aRelatedset === null && ($this->relatedset_id !== null)) {
