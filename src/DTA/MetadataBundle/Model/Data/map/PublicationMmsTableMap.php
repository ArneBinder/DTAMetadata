...
/**
 * This class defines the structure of the 'publication_mms' table.
 *
 *
 *
 ...
 */
class PublicationMmsTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.DTA.MetadataBundle.Model.Data.map.PublicationMmsTableMap';
    ...
    {
        // attributes
        $this->setName('publication_mms');
        $this->setPhpName('PublicationMms');
        $this->setClassname('DTA\\MetadataBundle\\Model\\Data\\PublicationMms');
        $this->setPackage('src.DTA.MetadataBundle.Model.Data');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('publication_mms_id_seq');
        // columns
