...
/**
 * This class defines the structure of the 'publication_m' table.
 *
 *
 *
 ...
 */
class PublicationMTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.DTA.MetadataBundle.Model.Data.map.PublicationMTableMap';
    ...
    {
        // attributes
        $this->setName('publication_m');
        $this->setPhpName('PublicationM');
        $this->setClassname('DTA\\MetadataBundle\\Model\\Data\\PublicationM');
        $this->setPackage('src.DTA.MetadataBundle.Model.Data');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('publication_m_id_seq');
        // columns
