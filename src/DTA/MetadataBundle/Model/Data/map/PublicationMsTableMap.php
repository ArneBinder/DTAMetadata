...
/**
 * This class defines the structure of the 'publication_ms' table.
 *
 *
 *
 ...
 */
class PublicationMsTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.DTA.MetadataBundle.Model.Data.map.PublicationMsTableMap';
    ...
    {
        // attributes
        $this->setName('publication_ms');
        $this->setPhpName('PublicationMs');
        $this->setClassname('DTA\\MetadataBundle\\Model\\Data\\PublicationMs');
        $this->setPackage('src.DTA.MetadataBundle.Model.Data');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('publication_ms_id_seq');
        // columns
        ...
        $this->addColumn('volumenumberinseries', 'Volumenumberinseries', 'LONGVARCHAR', false, null, null);
        // validators
    } // initialize()
