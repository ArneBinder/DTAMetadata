...
/**
 * This class defines the structure of the 'publication_mm' table.
 *
 *
 *
 ...
 */
class PublicationMmTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.DTA.MetadataBundle.Model.Data.map.PublicationMmTableMap';
    ...
    {
        // attributes
        $this->setName('publication_mm');
        $this->setPhpName('PublicationMm');
        $this->setClassname('DTA\\MetadataBundle\\Model\\Data\\PublicationMm');
        $this->setPackage('src.DTA.MetadataBundle.Model.Data');
        $this->setUseIdGenerator(true);
        $this->setPrimaryKeyMethodInfo('publication_mm_id_seq');
        // columns
