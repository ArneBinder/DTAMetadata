...
abstract class BasePublicationMs extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Data\\PublicationMsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PublicationMsPeer
     */
    ...
    /**
     * The value for the volumenumberinseries field.
     * @var        string
     */
    protected $volumenumberinseries;
    ...
    /**
     * Get the [volumenumberinseries] column value.
     * Nummer des Bandes innerhalb der Reihe
     * @return string
     */
    public function getVolumenumberinseries()
    {

        return $this->volumenumberinseries;
    }
     ...
     * @return PublicationMs The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PublicationMsPeer::ID;
        }
    ...
    public function setPublicationId($v)
    {
        ...
        if ($this->publication_id !== $v) {
            ...
            $this->modifiedColumns[] = PublicationMsPeer::PUBLICATION_ID;
        }
    ...
    public function setSeriesId($v)
    {
        ...
        if ($this->series_id !== $v) {
            $this->series_id = $v;
            $this->modifiedColumns[] = PublicationMsPeer::SERIES_ID;
        }
    ...
    /**
     * Set the value of [volumenumberinseries] column.
     * Nummer des Bandes innerhalb der Reihe
     * @param  string $v new value
     * @return PublicationMs The current object (for fluent API support)
     */
    public function setVolumenumberinseries($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->volumenumberinseries !== $v) {
            $this->volumenumberinseries = $v;
            $this->modifiedColumns[] = PublicationMsPeer::VOLUMENUMBERINSERIES;
        }


        return $this;
    } // setVolumenumberinseries()
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PublicationMsPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PublicationMsPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->volumenumberinseries = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            return $startcol + 6; // 6 = PublicationMsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PublicationMs object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PublicationMsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PublicationMsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PublicationMsPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PublicationMsPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PublicationMsPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PublicationMsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('publication_ms_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(PublicationMsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(PublicationMsPeer::PUBLICATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '"publication_id"';
        }
        if ($this->isColumnModified(PublicationMsPeer::SERIES_ID)) {
            $modifiedColumns[':p' . $index++]  = '"series_id"';
        }
        if ($this->isColumnModified(PublicationMsPeer::VOLUMENUMBERINSERIES)) {
            $modifiedColumns[':p' . $index++]  = '"volumenumberinseries"';
        }
        if ($this->isColumnModified(PublicationMsPeer::CREATED_AT)) {
        ...
        $sql = sprintf(
            'INSERT INTO "publication_ms" (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '"series_id"':
                        ...
                        break;
                    case '"volumenumberinseries"':
                        $stmt->bindValue($identifier, $this->volumenumberinseries, PDO::PARAM_STR);
                        break;
                    case '"created_at"':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PublicationMsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PublicationMsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                return $this->getVolumenumberinseries();
                break;
            case 4:
    ...
    {
        if (isset($alreadyDumpedObjects['PublicationMs'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PublicationMs'][$this->getPrimaryKey()] = true;
        $keys = PublicationMsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getPublicationId(),
            $keys[2] => $this->getSeriesId(),
            $keys[3] => $this->getVolumenumberinseries(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setVolumenumberinseries($value);
                break;
            case 4:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setVolumenumberinseries($arr[$keys[3]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PublicationMsPeer::ID)) $criteria->add(PublicationMsPeer::ID, $this->id);
        if ($this->isColumnModified(PublicationMsPeer::PUBLICATION_ID)) $criteria->add(PublicationMsPeer::PUBLICATION_ID, $this->publication_id);
        if ($this->isColumnModified(PublicationMsPeer::SERIES_ID)) $criteria->add(PublicationMsPeer::SERIES_ID, $this->series_id);
        if ($this->isColumnModified(PublicationMsPeer::VOLUMENUMBERINSERIES)) $criteria->add(PublicationMsPeer::VOLUMENUMBERINSERIES, $this->volumenumberinseries);
        if ($this->isColumnModified(PublicationMsPeer::CREATED_AT)) $criteria->add(PublicationMsPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PublicationMsPeer::UPDATED_AT)) $criteria->add(PublicationMsPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PublicationMsPeer::DATABASE_NAME);
        $criteria->add(PublicationMsPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PublicationMs (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setVolumenumberinseries($this->getVolumenumberinseries());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PublicationMs Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PublicationMsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PublicationMsPeer();
        }
    ...
    public function getPublication(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPublication === null && ($this->publication_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPublication->addPublicationMss($this);
             */
        }
    ...
    public function getSeries(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aSeries === null && ($this->series_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSeries->addPublicationMss($this);
             */
        }
    ...
    public function clear()
    {
        ...
        $this->series_id = null;
        $this->volumenumberinseries = null;
    ...
    {
        return (string) $this->exportTo(PublicationMsPeer::DEFAULT_STRING_FORMAT);
    }
