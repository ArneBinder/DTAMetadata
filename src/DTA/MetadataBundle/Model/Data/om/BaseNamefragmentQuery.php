 ...
 * @method NamefragmentQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method NamefragmentQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 ...
 * @method NamefragmentQuery groupByCreatedAt() Group by the created_at column
 * @method NamefragmentQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 * @method Namefragment findOneByCreatedAt(string $created_at) Return the first Namefragment filtered by the created_at column
 * @method Namefragment findOneByUpdatedAt(string $updated_at) Return the first Namefragment filtered by the updated_at column
 *
 ...
 * @method array findByCreatedAt(string $created_at) Return Namefragment objects filtered by the created_at column
 * @method array findByUpdatedAt(string $updated_at) Return Namefragment objects filtered by the updated_at column
 */
abstract class BaseNamefragmentQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'DTA\\MetadataBundle\\Model\\Data\\Namefragment';
        }
    ...
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new NamefragmentQuery(null, null, $modelAlias);
    ...
    {
        $sql = 'SELECT "id", "personalname_id", "name", "namefragmenttypeid", "sortable_rank", "created_at", "updated_at" FROM "namefragment" WHERE "id" = :p0';
        try {
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(NamefragmentPeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(NamefragmentPeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(NamefragmentPeer::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(NamefragmentPeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(NamefragmentPeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(NamefragmentPeer::UPDATED_AT, $updatedAt, $comparison);
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \DTA\MetadataBundle\Model\Classification\NamefragmenttypeQuery A secondary query class using the current class as primary query
     */
    public function useNamefragmenttypeQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'Namefragmenttype', '\DTA\MetadataBundle\Model\Classification\NamefragmenttypeQuery');
    }
    ...
    public function inList($scope)
    {
        ...
        NamefragmentPeer::sortableApplyScopeCriteria($this, $scope, 'addUsingAlias');
    ...
    public function getMaxRank($scope, PropelPDO $con = null)
    {
        ...
        NamefragmentPeer::sortableApplyScopeCriteria($this, $scope);
    ...
    {
        return $this->addUsingAlias(NamefragmentPeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(NamefragmentPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(NamefragmentPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(NamefragmentPeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(NamefragmentPeer::CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(NamefragmentPeer::CREATED_AT);
    }
}
