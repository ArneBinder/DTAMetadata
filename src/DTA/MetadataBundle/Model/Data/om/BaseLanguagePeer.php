...
use DTA\MetadataBundle\Model\Data\map\LanguageTableMap;
...
abstract class BaseLanguagePeer
{
    ...
    const OM_CLASS = 'DTA\\MetadataBundle\\Model\\Data\\Language';

    /** the related TableMap class for this table */
    const TM_CLASS = 'DTA\\MetadataBundle\\Model\\Data\\map\\LanguageTableMap';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (LanguagePeer::ID, LanguagePeer::NAME, LanguagePeer::CREATED_AT, LanguagePeer::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (LanguagePeer::ID => 0, LanguagePeer::NAME => 1, LanguagePeer::CREATED_AT => 2, LanguagePeer::UPDATED_AT => 3, ),
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseLanguagePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \DTA\MetadataBundle\Model\Data\map\LanguageTableMap());
      }
    }
