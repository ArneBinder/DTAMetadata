 ...
 * @method PlaceQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method PlaceQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 ...
 * @method PlaceQuery groupByCreatedAt() Group by the created_at column
 * @method PlaceQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 * @method Place findOneByCreatedAt(string $created_at) Return the first Place filtered by the created_at column
 * @method Place findOneByUpdatedAt(string $updated_at) Return the first Place filtered by the updated_at column
 *
 ...
 * @method array findByCreatedAt(string $created_at) Return Place objects filtered by the created_at column
 * @method array findByUpdatedAt(string $updated_at) Return Place objects filtered by the updated_at column
 */
abstract class BasePlaceQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'DTA\\MetadataBundle\\Model\\Data\\Place';
        }
    ...
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new PlaceQuery(null, null, $modelAlias);
    ...
    {
        $sql = 'SELECT "id", "name", "gnd", "created_at", "updated_at" FROM "place" WHERE "id" = :p0';
        try {
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(PlacePeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(PlacePeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PlacePeer::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(PlacePeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(PlacePeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PlacePeer::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(PlacePeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PlacePeer::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PlacePeer::UPDATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(PlacePeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PlacePeer::CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PlacePeer::CREATED_AT);
    }
}
