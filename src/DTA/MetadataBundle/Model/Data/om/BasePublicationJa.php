...
abstract class BasePublicationJa extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Data\\PublicationJaPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PublicationJaPeer
     */
     ...
     * Teil (bei einer mehrteiligen Publikation)
     * @return int
     */
     ...
     * @return PublicationJa The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PublicationJaPeer::ID;
        }
    ...
    public function setPublicationId($v)
    {
        ...
        if ($this->publication_id !== $v) {
            ...
            $this->modifiedColumns[] = PublicationJaPeer::PUBLICATION_ID;
        }
    ...
    public function setVolumeId($v)
    {
        ...
        if ($this->volume_id !== $v) {
            $this->volume_id = $v;
            $this->modifiedColumns[] = PublicationJaPeer::VOLUME_ID;
        }
    ...
    public function setParent($v)
    {
        ...
        if ($this->parent !== $v) {
            $this->parent = $v;
            $this->modifiedColumns[] = PublicationJaPeer::PARENT;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->volume_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            return $startcol + 4; // 4 = PublicationJaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PublicationJa object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PublicationJaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PublicationJaQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PublicationJaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('publication_ja_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(PublicationJaPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(PublicationJaPeer::PUBLICATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '"publication_id"';
        }
        if ($this->isColumnModified(PublicationJaPeer::VOLUME_ID)) {
            $modifiedColumns[':p' . $index++]  = '"volume_id"';
        }
        if ($this->isColumnModified(PublicationJaPeer::PARENT)) {
            $modifiedColumns[':p' . $index++]  = '"parent"';
        }

        $sql = sprintf(
            'INSERT INTO "publication_ja" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PublicationJaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PublicationJaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PublicationJa'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PublicationJa'][$this->getPrimaryKey()] = true;
        $keys = PublicationJaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getPublicationId(),
            $keys[2] => $this->getVolumeId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setVolumeId($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PublicationJaPeer::ID)) $criteria->add(PublicationJaPeer::ID, $this->id);
        if ($this->isColumnModified(PublicationJaPeer::PUBLICATION_ID)) $criteria->add(PublicationJaPeer::PUBLICATION_ID, $this->publication_id);
        if ($this->isColumnModified(PublicationJaPeer::VOLUME_ID)) $criteria->add(PublicationJaPeer::VOLUME_ID, $this->volume_id);
        if ($this->isColumnModified(PublicationJaPeer::PARENT)) $criteria->add(PublicationJaPeer::PARENT, $this->parent);
    ...
    {
        $criteria = new Criteria(PublicationJaPeer::DATABASE_NAME);
        $criteria->add(PublicationJaPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PublicationJa (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PublicationJa Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PublicationJaPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PublicationJaPeer();
        }
    ...
    public function setPublicationRelatedByPublicationId(Publication $v = null)
    {
        ...
        if ($v !== null) {
            $v->addPublicationJaRelatedByPublicationId($this);
        }
    ...
    public function getPublicationRelatedByPublicationId(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPublicationRelatedByPublicationId === null && ($this->publication_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPublicationRelatedByPublicationId->addPublicationJasRelatedByPublicationId($this);
             */
        }
    ...
    public function setPublicationRelatedByParent(Publication $v = null)
    {
        ...
        // If this object has already been added to the Publication object, it will not be re-added.
        if ($v !== null) {
            $v->addPublicationJaRelatedByParent($this);
        }
    ...
    public function getPublicationRelatedByParent(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPublicationRelatedByParent === null && ($this->parent !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPublicationRelatedByParent->addPublicationJasRelatedByParent($this);
             */
        }
    ...
    public function getVolume(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aVolume === null && ($this->volume_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVolume->addPublicationJas($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PublicationJaPeer::DEFAULT_STRING_FORMAT);
    }
