...
abstract class BaseMultiVolume extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->volumes_total = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            return $startcol + 4; // 4 = MultiVolumePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setVolumesTotal($arr[$keys[1]]);
    ...
    {
        $criteria = new Criteria(MultiVolumePeer::DATABASE_NAME);
        $criteria->add(MultiVolumePeer::PUBLICATION_ID, $this->publication_id);
    ...
    public function getPublication(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPublication === null && ($this->publication_id !== null) && $doQuery) {
            ...
            $this->aPublication->setMultiVolume($this);
        }
