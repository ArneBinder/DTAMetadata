...
abstract class BasePublishingcompany extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Data\\PublishingcompanyPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PublishingcompanyPeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PublishingcompanyPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = PublishingcompanyPeer::NAME;
        }
    ...
    public function setGnd($v)
    {
        ...
        if ($this->gnd !== $v) {
            $this->gnd = $v;
            $this->modifiedColumns[] = PublishingcompanyPeer::GND;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PublishingcompanyPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PublishingcompanyPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = PublishingcompanyPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Publishingcompany object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PublishingcompanyPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PublishingcompanyQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PublishingcompanyPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PublishingcompanyPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PublishingcompanyPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PublishingcompanyPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('publishingcompany_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(PublishingcompanyPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(PublishingcompanyPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '"name"';
        }
        if ($this->isColumnModified(PublishingcompanyPeer::GND)) {
        ...
        $sql = sprintf(
            'INSERT INTO "publishingcompany" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PublishingcompanyPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PublishingcompanyPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Publishingcompany'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Publishingcompany'][$this->getPrimaryKey()] = true;
        $keys = PublishingcompanyPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getGnd(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PublishingcompanyPeer::ID)) $criteria->add(PublishingcompanyPeer::ID, $this->id);
        if ($this->isColumnModified(PublishingcompanyPeer::NAME)) $criteria->add(PublishingcompanyPeer::NAME, $this->name);
        if ($this->isColumnModified(PublishingcompanyPeer::GND)) $criteria->add(PublishingcompanyPeer::GND, $this->gnd);
        if ($this->isColumnModified(PublishingcompanyPeer::CREATED_AT)) $criteria->add(PublishingcompanyPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PublishingcompanyPeer::UPDATED_AT)) $criteria->add(PublishingcompanyPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PublishingcompanyPeer::DATABASE_NAME);
        $criteria->add(PublishingcompanyPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Publishingcompany (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Publishingcompany Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PublishingcompanyPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PublishingcompanyPeer();
        }
     ...
     * If this Publishingcompany is new, it will return
    ...
    protected function doAddPublication($publication)
    {
        ...
        $publication->setPublishingcompany($this);
    }
    ...
    public function removePublication($publication)
    {
        if ($this->getPublications()->contains($publication)) {
            ...
            $publication->setPublishingcompany(null);
        }
    ...
    {
        return (string) $this->exportTo(PublishingcompanyPeer::DEFAULT_STRING_FORMAT);
    }
