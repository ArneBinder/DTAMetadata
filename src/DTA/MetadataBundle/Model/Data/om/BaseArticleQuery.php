 ...
 *
 * @method ArticleQuery leftJoinPublication($relationAlias = null) Adds a LEFT JOIN clause to the query using the Publication relation
 * @method ArticleQuery rightJoinPublication($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Publication relation
 * @method ArticleQuery innerJoinPublication($relationAlias = null) Adds a INNER JOIN clause to the query using the Publication relation
 *
...
abstract class BaseArticleQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'DTA\\MetadataBundle\\Model\\Data\\Article';
        }
    ...
    public function filterByPublicationId($publicationId = null, $comparison = null)
    {
        if (is_array($publicationId)) {
            ...
            if (isset($publicationId['min'])) {
                $this->addUsingAlias(ArticlePeer::PUBLICATION_ID, $publicationId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($publicationId['max'])) {
                $this->addUsingAlias(ArticlePeer::PUBLICATION_ID, $publicationId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ArticlePeer::PUBLICATION_ID, $publicationId, $comparison);
    }
    ...
    public function filterByPages($pages = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ArticlePeer::PAGES, $pages, $comparison);
    }
    ...
    public function filterByPublication($publication, $comparison = null)
    {
        if ($publication instanceof Publication) {
            return $this
                ->addUsingAlias(ArticlePeer::PUBLICATION_ID, $publication->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ArticlePeer::PUBLICATION_ID, $publication->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
