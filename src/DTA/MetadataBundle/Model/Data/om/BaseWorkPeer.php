...
use DTA\MetadataBundle\Model\Data\map\WorkTableMap;
...
abstract class BaseWorkPeer
{
    ...
    const OM_CLASS = 'DTA\\MetadataBundle\\Model\\Data\\Work';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'TitleId', 'DatespecificationId', 'Doi', 'Comments', 'Format', 'Directoryname', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'titleId', 'datespecificationId', 'doi', 'comments', 'format', 'directoryname', ),
        BasePeer::TYPE_COLNAME => array (WorkPeer::ID, WorkPeer::TITLE_ID, WorkPeer::DATESPECIFICATION_ID, WorkPeer::DOI, WorkPeer::COMMENTS, WorkPeer::FORMAT, WorkPeer::DIRECTORYNAME, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'TITLE_ID', 'DATESPECIFICATION_ID', 'DOI', 'COMMENTS', 'FORMAT', 'DIRECTORYNAME', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'title_id', 'datespecification_id', 'doi', 'comments', 'format', 'directoryname', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'TitleId' => 1, 'DatespecificationId' => 2, 'Doi' => 3, 'Comments' => 4, 'Format' => 5, 'Directoryname' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'titleId' => 1, 'datespecificationId' => 2, 'doi' => 3, 'comments' => 4, 'format' => 5, 'directoryname' => 6, ),
        BasePeer::TYPE_COLNAME => array (WorkPeer::ID => 0, WorkPeer::TITLE_ID => 1, WorkPeer::DATESPECIFICATION_ID => 2, WorkPeer::DOI => 3, WorkPeer::COMMENTS => 4, WorkPeer::FORMAT => 5, WorkPeer::DIRECTORYNAME => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'TITLE_ID' => 1, 'DATESPECIFICATION_ID' => 2, 'DOI' => 3, 'COMMENTS' => 4, 'FORMAT' => 5, 'DIRECTORYNAME' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title_id' => 1, 'datespecification_id' => 2, 'doi' => 3, 'comments' => 4, 'format' => 5, 'directoryname' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(WorkPeer::TITLE_ID);
    ...
    public static function doCountJoinTitle(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(WorkPeer::TITLE_ID, TitlePeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Work objects pre-filled with their Title objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinTitle(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Work) to $obj2 (Title)
                $obj2->addWork($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Work) to the collection in $obj2 (Title)
                $obj2->addWork($obj1);
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (Work) to the collection in $obj3 (Datespecification)
                $obj3->addWork($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of Work objects pre-filled with all related objects except Title.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptTitle(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        DatespecificationPeer::addSelectColumns($criteria);
        $startcol3 = $startcol2 + DatespecificationPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = WorkPeer::getInstanceFromPool($key1))) {
                ...
                $key2 = DatespecificationPeer::getPrimaryKeyHashFromRow($row, $startcol2);
                if ($key2 !== null) {
                    $obj2 = DatespecificationPeer::getInstanceFromPool($key2);
                    if (!$obj2) {
                ...
                // Add the $obj1 (Work) to the collection in $obj2 (Datespecification)
                $obj2->addWork($obj1);
