...
use DTA\MetadataBundle\Model\Data\map\ChapterTableMap;
...
abstract class BaseChapterPeer
{
    ...
    const OM_CLASS = 'DTA\\MetadataBundle\\Model\\Data\\Chapter';
    ...
    const UPDATED_AT = 'chapter.updated_at';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Chapter objects.
    ...
    {
        $toNames = ChapterPeer::getFieldNames($toType);
        $key = isset(ChapterPeer::$fieldKeys[$fromType][$name]) ? ChapterPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(ChapterPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, ChapterPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return ChapterPeer::$fieldNames[$type];
    }
     ...
     * @param      string $column The column name for current table. (i.e. ChapterPeer::COLUMN_NAME).
     * @return string
     */
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setPrimaryTableName(ChapterPeer::TABLE_NAME);
        ...
        $criteria->setDbName(ChapterPeer::DATABASE_NAME); // Set the correct dbName
    ...
    {
        return ChapterPeer::populateObjects(ChapterPeer::doSelectStmt($criteria, $con));
    }
    /**
     ...
     *
     * @param Chapter $obj A Chapter object.
     ...
     *
     * @param      mixed $value A Chapter object or a primary key value.
     *
     * @return void
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Chapter) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Chapter object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
                throw $e;
            }

            unset(ChapterPeer::$instances[$key]);
        }
     ...
     * @return Chapter Found object or null if 1) no instance exists for specified key or 2) instance pooling has been disabled.
     * @see        getPrimaryKeyHash()
     */
    public static function getInstanceFromPool($key)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(ChapterPeer::$instances[$key])) {
                return ChapterPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (ChapterPeer::$instances as $instance) {
          $instance->clearAllReferences(true);
        }
      }
        ChapterPeer::$instances = array();
    }

    /**
     * Method to invalidate the instance pool of all tables related to chapter
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key = ChapterPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj = ChapterPeer::getInstanceFromPool($key))) {
                ...
                $obj->hydrate($row);
                $results[] = $obj;
                ChapterPeer::addInstanceToPool($obj, $key);
            } // if key exists
        }
        $stmt->closeCursor();
    ...
    {
        $key = ChapterPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = ChapterPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + ChapterPeer::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = ChapterPeer::OM_CLASS;
            $obj = new $cls();
    ...
    public static function doCountJoinPublication(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ChapterPeer::PUBLICATION_ID, PublicationPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Chapter objects pre-filled with their Publication objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinPublication(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        ChapterPeer::addSelectColumns($criteria);
        $startcol = ChapterPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = ChapterPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = ChapterPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                ChapterPeer::addInstanceToPool($obj1, $key1);
    ...
    /**
     * Selects a collection of Chapter objects pre-filled with all related objects.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        ChapterPeer::addSelectColumns($criteria);
        $startcol2 = ChapterPeer::NUM_HYDRATE_COLUMNS;
    ...
    {
        return Propel::getDatabaseMap(ChapterPeer::DATABASE_NAME)->getTable(ChapterPeer::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getDatabaseMap(BaseChapterPeer::DATABASE_NAME);
      if (!$dbMap->hasTable(BaseChapterPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \DTA\MetadataBundle\Model\Data\map\ChapterTableMap());
      }
    }
    ...
    {
        return ChapterPeer::OM_CLASS;
    }

    /**
     * Performs an INSERT on the database, given a Chapter or Criteria object.
     *
     * @param      mixed $values Criteria or Chapter object containing data that is used to create the INSERT statement.
    ...
    {
        if ($con === null) {
            $con = Propel::getConnection(ChapterPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
        }
    ...
    /**
     * Performs an UPDATE on the database, given a Chapter or Criteria object.
     *
     * @param      mixed $values Criteria or Chapter object containing data that is used to create the UPDATE statement.
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(ChapterPeer::DATABASE_NAME);
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(ChapterPeer::TABLE_NAME, $con, ChapterPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            ChapterPeer::clearInstancePool();
            ChapterPeer::clearRelatedInstancePool();
            $con->commit();
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            ChapterPeer::removeInstanceFromPool($values);
    ...
    /**
     * Validates all modified columns of given Chapter object.
     * If parameter $columns is either a single column name or an array of column names
     * than only those columns are validated.
     *
     * NOTICE: This does not apply to primary or foreign keys for now.
     *
     * @param Chapter $obj The object to validate.
    ...
    public static function doValidate($obj, $cols = null)
    {
        ...
        return BasePeer::doValidate(ChapterPeer::DATABASE_NAME, ChapterPeer::TABLE_NAME, $columns);
    }
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        if (null !== ($obj = ChapterPeer::getInstanceFromPool((string) $pk))) {
            return $obj;
        }
