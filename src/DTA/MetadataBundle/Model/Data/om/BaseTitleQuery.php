 ...
 * @method TitleQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method TitleQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 * @method TitleQuery groupById() Group by the id column
 * @method TitleQuery groupByCreatedAt() Group by the created_at column
 * @method TitleQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 *
 * @method Title findOneByCreatedAt(string $created_at) Return the first Title filtered by the created_at column
 * @method Title findOneByUpdatedAt(string $updated_at) Return the first Title filtered by the updated_at column
 *
 * @method array findById(int $id) Return Title objects filtered by the id column
 * @method array findByCreatedAt(string $created_at) Return Title objects filtered by the created_at column
 * @method array findByUpdatedAt(string $updated_at) Return Title objects filtered by the updated_at column
 */
abstract class BaseTitleQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "id", "created_at", "updated_at" FROM "title" WHERE "id" = :p0';
        try {
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(TitlePeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(TitlePeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TitlePeer::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(TitlePeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(TitlePeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TitlePeer::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(TitlePeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(TitlePeer::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(TitlePeer::UPDATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(TitlePeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(TitlePeer::CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(TitlePeer::CREATED_AT);
    }
}
