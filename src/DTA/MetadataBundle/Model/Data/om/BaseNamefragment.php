...
abstract class BaseNamefragment extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Data\\NamefragmentPeer';
    ...
    public function setPersonalnameId($v)
    {
        ...
        if ($this->personalname_id !== $v) {
            // sortable behavior
            $this->oldScope = $this->personalname_id;
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = NamefragmentPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = NamefragmentPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = NamefragmentPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            ...
            NamefragmentPeer::shiftRank(-1, $this->getSortableRank() + 1, null, $this->getScopeValue(), $con);
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(NamefragmentPeer::RANK_COL)) {
                    $this->setSortableRank(NamefragmentQuery::create()->getMaxRankArray($this->getScopeValue(), $con) + 1);
                }

                // timestampable behavior
                if (!$this->isColumnModified(NamefragmentPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(NamefragmentPeer::UPDATED_AT)) {
                ...
                if (($this->isColumnModified(NamefragmentPeer::PERSONALNAME_ID)) && !$this->isColumnModified(NamefragmentPeer::RANK_COL)) { NamefragmentPeer::shiftRank(-1, $this->getSortableRank() + 1, null, $this->oldScope, $con);
                    $this->insertAtBottom($con);
                }

                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(NamefragmentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('namefragment_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NamefragmentPeer::CREATED_AT)) $criteria->add(NamefragmentPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(NamefragmentPeer::UPDATED_AT)) $criteria->add(NamefragmentPeer::UPDATED_AT, $this->updated_at);
     ...
     * @throws PropelException
     */
    public function getNamefragmenttype(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aNamefragmenttype === null && ($this->namefragmenttypeid !== null) && $doQuery) {
     ...
     * @throws PropelException
     */
    public function getPersonalname(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPersonalname === null && ($this->personalname_id !== null) && $doQuery) {
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aNamefragmenttype instanceof Persistent) {
              $this->aNamefragmenttype->clearAllReferences($deep);
            }
            if ($this->aPersonalname instanceof Persistent) {
              $this->aPersonalname->clearAllReferences($deep);
            }
    ...
    {
        return $this->getSortableRank() == NamefragmentQuery::create()->getMaxRankArray($this->getScopeValue(), $con);
    }
    ...
    public function getNext(PropelPDO $con = null)
    {
        ...
        $query = NamefragmentQuery::create();
    ...
    {
        $maxRank = NamefragmentQuery::create()->getMaxRankArray($this->getScopeValue(), $con);
    ...
    public function moveToRank($newRank, PropelPDO $con = null)
    {
        ...
        if ($newRank < 1 || $newRank > NamefragmentQuery::create()->getMaxRankArray($this->getScopeValue(), $con)) {
        ...
        try {
            ...
            NamefragmentPeer::shiftRank($delta, min($oldRank, $newRank), max($oldRank, $newRank), $this->getScopeValue(), $con);
    ...
    public function moveToBottom(PropelPDO $con = null)
    {
        ...
        $con->beginTransaction();
        try {
            $bottom = NamefragmentQuery::create()->getMaxRankArray($this->getScopeValue(), $con);
    ...
    public function getRepresentativeNamefragmenttype(){

        if ($this->countNamefragmenttypes() > 0) {

            $pn = $this->getNamefragmenttypes();

            // sort by rank if available
            $rc = new \ReflectionClass(new Namefragmenttype());
