...
abstract class BaseTitlePeer
{
    ...
    const OM_CLASS = 'DTA\\MetadataBundle\\Model\\Data\\Title';

    /** the related TableMap class for this table */
    const TM_CLASS = 'DTA\\MetadataBundle\\Model\\Data\\map\\TitleTableMap';
    ...
    /**
     * An identity map to hold any loaded instances of Title objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (TitlePeer::ID, TitlePeer::CREATED_AT, TitlePeer::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (TitlePeer::ID => 0, TitlePeer::CREATED_AT => 1, TitlePeer::UPDATED_AT => 2, ),
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (TitlePeer::$instances as $instance) {
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseTitlePeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \DTA\MetadataBundle\Model\Data\map\TitleTableMap());
      }
    }
