 ...
 * @method FontQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method FontQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 * @method FontQuery groupById() Group by the id column
 * @method FontQuery groupByName() Group by the name column
 * @method FontQuery groupByCreatedAt() Group by the created_at column
 * @method FontQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 * @method Font findOneByCreatedAt(string $created_at) Return the first Font filtered by the created_at column
 * @method Font findOneByUpdatedAt(string $updated_at) Return the first Font filtered by the updated_at column
 *
 ...
 * @method array findByCreatedAt(string $created_at) Return Font objects filtered by the created_at column
 * @method array findByUpdatedAt(string $updated_at) Return Font objects filtered by the updated_at column
 */
abstract class BaseFontQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'DTA\\MetadataBundle\\Model\\Data\\Font';
        }
    ...
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new FontQuery(null, null, $modelAlias);
    ...
    {
        $sql = 'SELECT "id", "name", "created_at", "updated_at" FROM "font" WHERE "id" = :p0';
        try {
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(FontPeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(FontPeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(FontPeer::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(FontPeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(FontPeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(FontPeer::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(FontPeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(FontPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(FontPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(FontPeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(FontPeer::CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(FontPeer::CREATED_AT);
    }
}
