...
use DTA\MetadataBundle\Model\Data\NamefragmentQuery;
...
abstract class BasePersonalname extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Data\\PersonalnamePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PersonalnamePeer
     */
    ...
    /**
     * @var        PropelObjectCollection|Namefragment[] Collection to store aggregation of Namefragment objects.
     */
    protected $collNamefragments;
    protected $collNamefragmentsPartial;
     ...
     */
    protected $namefragmentsScheduledForDeletion = null;
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PersonalnamePeer::ID;
        }
    ...
    public function setPersonId($v)
    {
        ...
        if ($this->person_id !== $v) {
            $this->person_id = $v;
            $this->modifiedColumns[] = PersonalnamePeer::PERSON_ID;
        }
    ...
    public function setSortableRank($v)
    {
        ...
        if ($this->sortable_rank !== $v) {
            ...
            $this->modifiedColumns[] = PersonalnamePeer::SORTABLE_RANK;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PersonalnamePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PersonalnamePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = PersonalnamePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Personalname object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PersonalnamePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PersonalnameQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // sortable behavior

            PersonalnamePeer::shiftRank(-1, $this->getSortableRank() + 1, null, $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PersonalnamePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PersonalnamePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PersonalnamePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PersonalnamePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->namefragmentsScheduledForDeletion !== null) {
                if (!$this->namefragmentsScheduledForDeletion->isEmpty()) {
                    NamefragmentQuery::create()
                        ->filterByPrimaryKeys($this->namefragmentsScheduledForDeletion->getPrimaryKeys(false))
                        ->delete($con);
                    $this->namefragmentsScheduledForDeletion = null;
                }
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('personalname_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(PersonalnamePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(PersonalnamePeer::PERSON_ID)) {
            $modifiedColumns[':p' . $index++]  = '"person_id"';
        }
        if ($this->isColumnModified(PersonalnamePeer::SORTABLE_RANK)) {
        ...
        $sql = sprintf(
            'INSERT INTO "personalname" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PersonalnamePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PersonalnamePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Personalname'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Personalname'][$this->getPrimaryKey()] = true;
        $keys = PersonalnamePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PersonalnamePeer::ID)) $criteria->add(PersonalnamePeer::ID, $this->id);
        if ($this->isColumnModified(PersonalnamePeer::PERSON_ID)) $criteria->add(PersonalnamePeer::PERSON_ID, $this->person_id);
        if ($this->isColumnModified(PersonalnamePeer::SORTABLE_RANK)) $criteria->add(PersonalnamePeer::SORTABLE_RANK, $this->sortable_rank);
        if ($this->isColumnModified(PersonalnamePeer::CREATED_AT)) $criteria->add(PersonalnamePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PersonalnamePeer::UPDATED_AT)) $criteria->add(PersonalnamePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PersonalnamePeer::DATABASE_NAME);
        $criteria->add(PersonalnamePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Personalname (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($deepCopy && !$this->startCopy) {
            ...
            foreach ($this->getNamefragments() as $relObj) {
                if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
                    $copyObj->addNamefragment($relObj->copy($deepCopy));
                }
            }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Personalname Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PersonalnamePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PersonalnamePeer();
        }
    ...
    public function getPerson(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPerson === null && ($this->person_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPerson->addPersonalnames($this);
             */
        }
    ...
    {
        if ('Namefragment' == $relationName) {
            $this->initNamefragments();
        }
    }

    /**
     * Clears out the collNamefragments collection
     *
     * This does not modify the database; however, it will remove any associated objects, causing
     * them to be refetched by subsequent calls to accessor method.
     *
     * @return Personalname The current object (for fluent API support)
     * @see        addNamefragments()
     */
    public function clearNamefragments()
    {
        $this->collNamefragments = null; // important to set this to null since that means it is uninitialized
        $this->collNamefragmentsPartial = null;

        return $this;
    }

    /**
     * reset is the collNamefragments collection loaded partially
     *
     * @return void
     */
    public function resetPartialNamefragments($v = true)
    {
        $this->collNamefragmentsPartial = $v;
    }

    /**
     * Initializes the collNamefragments collection.
     *
     * By default this just sets the collNamefragments collection to an empty array (like clearcollNamefragments());
     ...
     * @return void
     */
    public function initNamefragments($overrideExisting = true)
    {
        if (null !== $this->collNamefragments && !$overrideExisting) {
            return;
        }
        $this->collNamefragments = new PropelObjectCollection();
        $this->collNamefragments->setModel('Namefragment');
    }

    /**
     * Gets an array of Namefragment objects which contain a foreign key that references this object.
     *
     * If the $criteria is not null, it is used to always fetch the results from the database.
     * Otherwise the results are fetched from the database the first time, then cached.
     * Next time the same method is called without $criteria, the cached collection is returned.
     * If this Personalname is new, it will return
     * an empty collection or the current collection; the criteria is ignored on a new object.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     * @return PropelObjectCollection|Namefragment[] List of Namefragment objects
     * @throws PropelException
     */
    public function getNamefragments($criteria = null, PropelPDO $con = null)
    {
        $partial = $this->collNamefragmentsPartial && !$this->isNew();
        if (null === $this->collNamefragments || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collNamefragments) {
                // return empty collection
                $this->initNamefragments();
            } else {
                $collNamefragments = NamefragmentQuery::create(null, $criteria)
                ...
                $this->collNamefragments = $collNamefragments;
                $this->collNamefragmentsPartial = false;
            }
        }

        return $this->collNamefragments;
    }

    /**
     * Sets a collection of Namefragment objects related by a one-to-many relationship
     * to the current object.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
     * @param PropelCollection $namefragments A Propel collection.
     * @param PropelPDO $con Optional connection object
     * @return Personalname The current object (for fluent API support)
     */
    public function setNamefragments(PropelCollection $namefragments, PropelPDO $con = null)
    {
        ...
        foreach ($namefragments as $namefragment) {
            $this->addNamefragment($namefragment);
        }

        $this->collNamefragments = $namefragments;
        $this->collNamefragmentsPartial = false;
    ...
    /**
     * Returns the number of related Namefragment objects.
     *
     * @param Criteria $criteria
     * @param boolean $distinct
     * @param PropelPDO $con
     * @return int             Count of related Namefragment objects.
     * @throws PropelException
     */
    public function countNamefragments(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
    {
        $partial = $this->collNamefragmentsPartial && !$this->isNew();
        if (null === $this->collNamefragments || null !== $criteria || $partial) {
            if ($this->isNew() && null === $this->collNamefragments) {
    ...
    /**
     * Method called to associate a Namefragment object to this object
     * through the Namefragment foreign key attribute.
     *
     * @param    Namefragment $l Namefragment
     * @return Personalname The current object (for fluent API support)
     */
    public function addNamefragment(Namefragment $l)
    {
        if ($this->collNamefragments === null) {
            $this->initNamefragments();
            $this->collNamefragmentsPartial = true;
    ...
    /**
     * @param	Namefragment $namefragment The namefragment object to add.
     */
    protected function doAddNamefragment($namefragment)
    {
        $this->collNamefragments[]= $namefragment;
        $namefragment->setPersonalname($this);
    }

    /**
     * @param	Namefragment $namefragment The namefragment object to remove.
     * @return Personalname The current object (for fluent API support)
     */
    public function removeNamefragment($namefragment)
    {
        if ($this->getNamefragments()->contains($namefragment)) {
            $this->collNamefragments->remove($this->collNamefragments->search($namefragment));
            if (null === $this->namefragmentsScheduledForDeletion) {
     ...
     * Otherwise if this Personalname is new, it will return
     * an empty collection; or if this Personalname has previously
     * been saved, it will retrieve related Namefragments from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Personalname.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Namefragment[] List of Namefragment objects
     */
    public function getNamefragmentsJoinNamefragmenttype($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = NamefragmentQuery::create(null, $criteria);
        $query->joinWith('Namefragmenttype', $join_behavior);

        return $this->getNamefragments($query, $con);
    }
    ...
    public function clearAllReferences($deep = false)
    {
        ...
        if ($this->collNamefragments instanceof PropelCollection) {
            $this->collNamefragments->clearIterator();
        }
        $this->collNamefragments = null;
        $this->aPerson = null;
    }
    ...
    {
        return (string) $this->exportTo(PersonalnamePeer::DEFAULT_STRING_FORMAT);
    }
     ...
     * @param     PropelPDO  $con      optional connection
     *
     * @return    Personalname the current object
     *
     * @throws    PropelException
     */
    ...
    public function moveToRank($newRank, PropelPDO $con = null)
    {
        ...
        try {
            ...
            PersonalnamePeer::shiftRank($delta, min($oldRank, $newRank), max($oldRank, $newRank), $con);
