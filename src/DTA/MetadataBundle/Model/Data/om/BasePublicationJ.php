...
abstract class BasePublicationJ extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Data\\PublicationJPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PublicationJPeer
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PublicationJPeer::ID;
        }
    ...
    public function setPublicationId($v)
    {
        ...
        if ($this->publication_id !== $v) {
            ...
            $this->modifiedColumns[] = PublicationJPeer::PUBLICATION_ID;
        }
    ...
    public function setEdition($v)
    {
        ...
        if ($this->edition !== $v) {
            $this->edition = $v;
            $this->modifiedColumns[] = PublicationJPeer::EDITION;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PublicationJPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PublicationJPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = PublicationJPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PublicationJ object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PublicationJPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PublicationJQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(PublicationJPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(PublicationJPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(PublicationJPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                PublicationJPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('publication_j_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(PublicationJPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(PublicationJPeer::PUBLICATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '"publication_id"';
        }
        if ($this->isColumnModified(PublicationJPeer::EDITION)) {
        ...
        $sql = sprintf(
            'INSERT INTO "publication_j" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PublicationJPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PublicationJPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PublicationJ'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PublicationJ'][$this->getPrimaryKey()] = true;
        $keys = PublicationJPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PublicationJPeer::ID)) $criteria->add(PublicationJPeer::ID, $this->id);
        if ($this->isColumnModified(PublicationJPeer::PUBLICATION_ID)) $criteria->add(PublicationJPeer::PUBLICATION_ID, $this->publication_id);
        if ($this->isColumnModified(PublicationJPeer::EDITION)) $criteria->add(PublicationJPeer::EDITION, $this->edition);
        if ($this->isColumnModified(PublicationJPeer::CREATED_AT)) $criteria->add(PublicationJPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(PublicationJPeer::UPDATED_AT)) $criteria->add(PublicationJPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(PublicationJPeer::DATABASE_NAME);
        $criteria->add(PublicationJPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PublicationJ (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PublicationJ Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PublicationJPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PublicationJPeer();
        }
    ...
    public function getPublication(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPublication === null && ($this->publication_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPublication->addPublicationJs($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PublicationJPeer::DEFAULT_STRING_FORMAT);
    }
