 ...
 * @method PublicationDsQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method PublicationDsQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 ...
 * @method PublicationDsQuery groupByCreatedAt() Group by the created_at column
 * @method PublicationDsQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 * @method PublicationDs findOneByCreatedAt(string $created_at) Return the first PublicationDs filtered by the created_at column
 * @method PublicationDs findOneByUpdatedAt(string $updated_at) Return the first PublicationDs filtered by the updated_at column
 *
 ...
 * @method array findByCreatedAt(string $created_at) Return PublicationDs objects filtered by the created_at column
 * @method array findByUpdatedAt(string $updated_at) Return PublicationDs objects filtered by the updated_at column
 */
abstract class BasePublicationDsQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT "id", "publication_id", "series_id", "pages", "created_at", "updated_at" FROM "publication_ds" WHERE "id" = :p0';
        try {
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(PublicationDsPeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(PublicationDsPeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PublicationDsPeer::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(PublicationDsPeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(PublicationDsPeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PublicationDsPeer::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(PublicationDsPeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PublicationDsPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PublicationDsPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(PublicationDsPeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PublicationDsPeer::CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PublicationDsPeer::CREATED_AT);
    }
}
