...
abstract class BaseArticle extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Data\\ArticlePeer';
    ...
    public function setPublicationId($v)
    {
        ...
        if ($this->publication_id !== $v) {
            ...
            $this->modifiedColumns[] = ArticlePeer::PUBLICATION_ID;
        }
    ...
    public function setPages($v)
    {
        ...
        if ($this->pages !== $v) {
            $this->pages = $v;
            $this->modifiedColumns[] = ArticlePeer::PAGES;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ArticlePeer::PAGES)) {
