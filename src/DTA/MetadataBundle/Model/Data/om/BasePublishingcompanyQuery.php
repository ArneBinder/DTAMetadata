 ...
 * @method PublishingcompanyQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method PublishingcompanyQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 ...
 * @method PublishingcompanyQuery groupByCreatedAt() Group by the created_at column
 * @method PublishingcompanyQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 * @method Publishingcompany findOneByCreatedAt(string $created_at) Return the first Publishingcompany filtered by the created_at column
 * @method Publishingcompany findOneByUpdatedAt(string $updated_at) Return the first Publishingcompany filtered by the updated_at column
 *
 ...
 * @method array findByCreatedAt(string $created_at) Return Publishingcompany objects filtered by the created_at column
 * @method array findByUpdatedAt(string $updated_at) Return Publishingcompany objects filtered by the updated_at column
 */
abstract class BasePublishingcompanyQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'DTA\\MetadataBundle\\Model\\Data\\Publishingcompany';
        }
    ...
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new PublishingcompanyQuery(null, null, $modelAlias);
    ...
    {
        $sql = 'SELECT "id", "name", "gnd", "created_at", "updated_at" FROM "publishingcompany" WHERE "id" = :p0';
        try {
    ...
    public function filterByCreatedAt($createdAt = null, $comparison = null)
    {
        if (is_array($createdAt)) {
            ...
            if (isset($createdAt['min'])) {
                $this->addUsingAlias(PublishingcompanyPeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($createdAt['max'])) {
                $this->addUsingAlias(PublishingcompanyPeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PublishingcompanyPeer::CREATED_AT, $createdAt, $comparison);
    }
    ...
    public function filterByUpdatedAt($updatedAt = null, $comparison = null)
    {
        if (is_array($updatedAt)) {
            ...
            if (isset($updatedAt['min'])) {
                $this->addUsingAlias(PublishingcompanyPeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($updatedAt['max'])) {
                $this->addUsingAlias(PublishingcompanyPeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PublishingcompanyPeer::UPDATED_AT, $updatedAt, $comparison);
    }
    ...
    {
        return $this->addUsingAlias(PublishingcompanyPeer::UPDATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PublishingcompanyPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PublishingcompanyPeer::UPDATED_AT);
    }
    ...
    {
        return $this->addUsingAlias(PublishingcompanyPeer::CREATED_AT, time() - $nbDays * 24 * 60 * 60, Criteria::GREATER_EQUAL);
    }
    ...
    {
        return $this->addDescendingOrderByColumn(PublishingcompanyPeer::CREATED_AT);
    }
    ...
    {
        return $this->addAscendingOrderByColumn(PublishingcompanyPeer::CREATED_AT);
    }
}
