...
abstract class BaseChapter extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Data\\ChapterPeer';
     ...
     * @return Chapter The current object (for fluent API support)
     */
    ...
    public function setPublicationId($v)
    {
        ...
        if ($this->publication_id !== $v) {
            ...
            $this->modifiedColumns[] = ChapterPeer::PUBLICATION_ID;
        }
    ...
    public function setPages($v)
    {
        ...
        if ($this->pages !== $v) {
            $this->pages = $v;
            $this->modifiedColumns[] = ChapterPeer::PAGES;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ChapterPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ChapterPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = ChapterPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ChapterPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ChapterQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(ChapterPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(ChapterPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(ChapterPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                ChapterPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('chapter_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(ChapterPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(ChapterPeer::PUBLICATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '"publication_id"';
        }
        if ($this->isColumnModified(ChapterPeer::PAGES)) {
    ...
    {
        if (isset($alreadyDumpedObjects['Chapter'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Chapter'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ChapterPeer::PUBLICATION_ID)) $criteria->add(ChapterPeer::PUBLICATION_ID, $this->publication_id);
        if ($this->isColumnModified(ChapterPeer::PAGES)) $criteria->add(ChapterPeer::PAGES, $this->pages);
        if ($this->isColumnModified(ChapterPeer::CREATED_AT)) $criteria->add(ChapterPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(ChapterPeer::UPDATED_AT)) $criteria->add(ChapterPeer::UPDATED_AT, $this->updated_at);
    ...
    public function getPublication(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPublication === null && ($this->publication_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPublication->addChapters($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ChapterPeer::DEFAULT_STRING_FORMAT);
    }
