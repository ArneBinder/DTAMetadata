...
abstract class BasePublicationDsPeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'PublicationId', 'SeriesId', 'Pages', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'publicationId', 'seriesId', 'pages', ),
        BasePeer::TYPE_COLNAME => array (PublicationDsPeer::ID, PublicationDsPeer::PUBLICATION_ID, PublicationDsPeer::SERIES_ID, PublicationDsPeer::PAGES, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PUBLICATION_ID', 'SERIES_ID', 'PAGES', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'publication_id', 'series_id', 'pages', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PublicationId' => 1, 'SeriesId' => 2, 'Pages' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'publicationId' => 1, 'seriesId' => 2, 'pages' => 3, ),
        BasePeer::TYPE_COLNAME => array (PublicationDsPeer::ID => 0, PublicationDsPeer::PUBLICATION_ID => 1, PublicationDsPeer::SERIES_ID => 2, PublicationDsPeer::PAGES => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PUBLICATION_ID' => 1, 'SERIES_ID' => 2, 'PAGES' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'publication_id' => 1, 'series_id' => 2, 'pages' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
