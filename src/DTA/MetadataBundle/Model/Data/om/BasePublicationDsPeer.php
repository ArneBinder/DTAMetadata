...
abstract class BasePublicationDsPeer
{
    ...
    const CREATED_AT = 'publication_ds.created_at';

    /** the column name for the updated_at field */
    const UPDATED_AT = 'publication_ds.updated_at';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'PublicationId', 'SeriesId', 'Pages', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'publicationId', 'seriesId', 'pages', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (PublicationDsPeer::ID, PublicationDsPeer::PUBLICATION_ID, PublicationDsPeer::SERIES_ID, PublicationDsPeer::PAGES, PublicationDsPeer::CREATED_AT, PublicationDsPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PUBLICATION_ID', 'SERIES_ID', 'PAGES', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'publication_id', 'series_id', 'pages', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'PublicationId' => 1, 'SeriesId' => 2, 'Pages' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'publicationId' => 1, 'seriesId' => 2, 'pages' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        BasePeer::TYPE_COLNAME => array (PublicationDsPeer::ID => 0, PublicationDsPeer::PUBLICATION_ID => 1, PublicationDsPeer::SERIES_ID => 2, PublicationDsPeer::PAGES => 3, PublicationDsPeer::CREATED_AT => 4, PublicationDsPeer::UPDATED_AT => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PUBLICATION_ID' => 1, 'SERIES_ID' => 2, 'PAGES' => 3, 'CREATED_AT' => 4, 'UPDATED_AT' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'publication_id' => 1, 'series_id' => 2, 'pages' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PublicationDsPeer::CREATED_AT);
            $criteria->addSelectColumn(PublicationDsPeer::UPDATED_AT);
        } else {
    ...
    public static function doSelectJoinAllExceptPublication(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = PublicationDsPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (PublicationDs) to the collection in $obj2 (Series)
                $obj2->addPublicationDs($obj1);
