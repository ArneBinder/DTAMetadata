...
abstract class BasePublicationMm extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Data\\PublicationMmPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        PublicationMmPeer
     */
     ...
     * @return PublicationMm The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PublicationMmPeer::ID;
        }
    ...
    public function setPublicationId($v)
    {
        ...
        if ($this->publication_id !== $v) {
            ...
            $this->modifiedColumns[] = PublicationMmPeer::PUBLICATION_ID;
        }
    ...
    public function setVolumeId($v)
    {
        ...
        if ($this->volume_id !== $v) {
            $this->volume_id = $v;
            $this->modifiedColumns[] = PublicationMmPeer::VOLUME_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = PublicationMmPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating PublicationMm object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PublicationMmPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PublicationMmQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PublicationMmPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('publication_mm_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(PublicationMmPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(PublicationMmPeer::PUBLICATION_ID)) {
            $modifiedColumns[':p' . $index++]  = '"publication_id"';
        }
        if ($this->isColumnModified(PublicationMmPeer::VOLUME_ID)) {
            $modifiedColumns[':p' . $index++]  = '"volume_id"';
        }

        $sql = sprintf(
            'INSERT INTO "publication_mm" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PublicationMmPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PublicationMmPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['PublicationMm'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PublicationMm'][$this->getPrimaryKey()] = true;
        $keys = PublicationMmPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PublicationMmPeer::ID)) $criteria->add(PublicationMmPeer::ID, $this->id);
        if ($this->isColumnModified(PublicationMmPeer::PUBLICATION_ID)) $criteria->add(PublicationMmPeer::PUBLICATION_ID, $this->publication_id);
        if ($this->isColumnModified(PublicationMmPeer::VOLUME_ID)) $criteria->add(PublicationMmPeer::VOLUME_ID, $this->volume_id);
    ...
    {
        $criteria = new Criteria(PublicationMmPeer::DATABASE_NAME);
        $criteria->add(PublicationMmPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of PublicationMm (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return PublicationMm Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return PublicationMmPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new PublicationMmPeer();
        }
    ...
    public function getPublication(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPublication === null && ($this->publication_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPublication->addPublicationMms($this);
             */
        }
    ...
    public function getVolume(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aVolume === null && ($this->volume_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aVolume->addPublicationMms($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(PublicationMmPeer::DEFAULT_STRING_FORMAT);
    }
