 ...
 * @method PublicationJQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method PublicationJQuery leftJoinPublication($relationAlias = null) Adds a LEFT JOIN clause to the query using the Publication relation
 * @method PublicationJQuery rightJoinPublication($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Publication relation
 * @method PublicationJQuery innerJoinPublication($relationAlias = null) Adds a INNER JOIN clause to the query using the Publication relation
 *
 * @method PublicationJ findOne(PropelPDO $con = null) Return the first PublicationJ matching the query
 * @method PublicationJ findOneOrCreate(PropelPDO $con = null) Return the first PublicationJ matching the query, or a new PublicationJ object populated from the query conditions when no match is found
 *
...
{
    /**
     * Initializes internal state of BasePublicationJQuery object.
     *
     * @param     string $dbName The dabase name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'DTAMetadata', $modelName = 'DTA\\MetadataBundle\\Model\\Data\\PublicationJ', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new PublicationJQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param   PublicationJQuery|Criteria $criteria Optional Criteria to build the query from
     *
     * @return PublicationJQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof PublicationJQuery) {
            return $criteria;
        }
        $query = new PublicationJQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return   PublicationJ|PublicationJ[]|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = PublicationJPeer::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return                 PublicationJ A model object, or null if the key is not found
    ...
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $obj = new PublicationJ();
            $obj->hydrate($row);
            PublicationJPeer::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
     ...
     * @param     PropelPDO $con an optional connection object
     *
     * @return PropelObjectCollection|PublicationJ[]|mixed the list of results, formatted by the current formatter
     */
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(PublicationJPeer::ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(PublicationJPeer::ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(PublicationJPeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(PublicationJPeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PublicationJPeer::ID, $id, $comparison);
    }
    ...
    public function filterByPublicationId($publicationId = null, $comparison = null)
    {
        if (is_array($publicationId)) {
            ...
            if (isset($publicationId['min'])) {
                $this->addUsingAlias(PublicationJPeer::PUBLICATION_ID, $publicationId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($publicationId['max'])) {
                $this->addUsingAlias(PublicationJPeer::PUBLICATION_ID, $publicationId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PublicationJPeer::PUBLICATION_ID, $publicationId, $comparison);
    }
    ...
    public function filterByEdition($edition = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PublicationJPeer::EDITION, $edition, $comparison);
    }
    ...
    public function filterByPublication($publication, $comparison = null)
    {
        if ($publication instanceof Publication) {
            return $this
                ->addUsingAlias(PublicationJPeer::PUBLICATION_ID, $publication->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(PublicationJPeer::PUBLICATION_ID, $publication->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     *
     * @param   PublicationJ $publicationJ Object to remove from the list of results
     *
     * @return PublicationJQuery The current query, for fluid interface
     */
    public function prune($publicationJ = null)
    {
        if ($publicationJ) {
            $this->addUsingAlias(PublicationJPeer::ID, $publicationJ->getId(), Criteria::NOT_EQUAL);
        }
