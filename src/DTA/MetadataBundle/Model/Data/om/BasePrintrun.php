...
abstract class BasePrintrun extends BaseObject implements Persistent, \DTA\MetadataBundle\Model\table_row_view\TableRowViewInterface
{
    /**
     * Peer class name
     */
    const PEER = 'DTA\\MetadataBundle\\Model\\Data\\PrintrunPeer';
    ...
    public static $tableRowViewCaptions = array('Id', 'Name', 'Numeric', 'Numpages', 'Numpagesnormed', );	public   $tableRowViewAccessors = array('Id'=>'Id', 'Name'=>'Name', 'Numeric'=>'Numeric', 'Numpages'=>'Numpages', 'Numpagesnormed'=>'Numpagesnormed', );
    /**
     ...
     * Numerische Bezeichnung der Ausgabe
     * @return int
     */
     ...
     * @return Printrun The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = PrintrunPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = PrintrunPeer::NAME;
        }
    ...
    public function setNumeric($v)
    {
        ...
        if ($this->numeric !== $v) {
            $this->numeric = $v;
            $this->modifiedColumns[] = PrintrunPeer::NUMERIC;
        }
    ...
    public function setNumpages($v)
    {
        ...
        if ($this->numpages !== $v) {
            $this->numpages = $v;
            $this->modifiedColumns[] = PrintrunPeer::NUMPAGES;
        }
    ...
    public function setNumpagesnormed($v)
    {
        ...
        if ($this->numpagesnormed !== $v) {
            ...
            $this->modifiedColumns[] = PrintrunPeer::NUMPAGESNORMED;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->numeric = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->numpages = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
            $this->numpagesnormed = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = PrintrunPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Printrun object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PrintrunPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PrintrunQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PrintrunPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if (null === $this->id) {
            try {
                $stmt = $con->query("SELECT nextval('printrun_id_seq')");
                $row = $stmt->fetch(PDO::FETCH_NUM);
                $this->id = $row[0];
            } catch (Exception $e) {
        ...
        if ($this->isColumnModified(PrintrunPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '"id"';
        }
        if ($this->isColumnModified(PrintrunPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '"name"';
        }
        if ($this->isColumnModified(PrintrunPeer::NUMERIC)) {
            $modifiedColumns[':p' . $index++]  = '"numeric"';
        }
        if ($this->isColumnModified(PrintrunPeer::NUMPAGES)) {
            $modifiedColumns[':p' . $index++]  = '"numpages"';
        }
        if ($this->isColumnModified(PrintrunPeer::NUMPAGESNORMED)) {
            $modifiedColumns[':p' . $index++]  = '"numpagesnormed"';
        }

        $sql = sprintf(
            'INSERT INTO "printrun" (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PrintrunPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PrintrunPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Printrun'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Printrun'][$this->getPrimaryKey()] = true;
        $keys = PrintrunPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
            $keys[2] => $this->getNumeric(),
            $keys[3] => $this->getNumpages(),
            $keys[4] => $this->getNumpagesnormed(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setNumpages($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setNumpagesnormed($arr[$keys[4]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PrintrunPeer::ID)) $criteria->add(PrintrunPeer::ID, $this->id);
        if ($this->isColumnModified(PrintrunPeer::NAME)) $criteria->add(PrintrunPeer::NAME, $this->name);
        if ($this->isColumnModified(PrintrunPeer::NUMERIC)) $criteria->add(PrintrunPeer::NUMERIC, $this->numeric);
        if ($this->isColumnModified(PrintrunPeer::NUMPAGES)) $criteria->add(PrintrunPeer::NUMPAGES, $this->numpages);
        if ($this->isColumnModified(PrintrunPeer::NUMPAGESNORMED)) $criteria->add(PrintrunPeer::NUMPAGESNORMED, $this->numpagesnormed);
    ...
    {
        $criteria = new Criteria(PrintrunPeer::DATABASE_NAME);
        $criteria->add(PrintrunPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Printrun (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Printrun Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Printrun is new, it will return
    ...
    public function setPublications(PropelCollection $publications, PropelPDO $con = null)
    {
        ...
        foreach ($publicationsToDelete as $publicationRemoved) {
            $publicationRemoved->setPrintrun(null);
        }
     ...
     * Otherwise if this Printrun is new, it will return
     * an empty collection; or if this Printrun has previously
     * been saved, it will retrieve related Publications from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Printrun.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    {
        return (string) $this->exportTo(PrintrunPeer::DEFAULT_STRING_FORMAT);
    }
