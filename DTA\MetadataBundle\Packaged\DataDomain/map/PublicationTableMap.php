 ...
 *
 * @package    propel.generator.DTA\MetadataBundle\Packaged\DataDomain.map
 */
class PublicationTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'DTA\MetadataBundle\Packaged\DataDomain.map.PublicationTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPackage('DTA\MetadataBundle\Packaged\DataDomain');
