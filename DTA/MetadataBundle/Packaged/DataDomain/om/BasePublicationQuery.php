...
use DTA\MetadataBundle\Model\DataDomain\PublicationQuery;
...
abstract class BasePublicationQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'DTAMetadata', $modelName = 'DTA\\MetadataBundle\\Model\\DataDomain\\Publication', $modelAlias = null)
    {
