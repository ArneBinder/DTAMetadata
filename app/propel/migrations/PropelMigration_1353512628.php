 ...
 * up to version 1353512628.
 * Generated on 2012-11-21 16:43:48 by stud
 */
class PropelMigration_1353512628
{
...
ALTER TABLE `dateSpecification` DROP `year_is_reconstructed`;
...
ALTER TABLE `dateSpecification`
    ADD `year_is_reconstructed` TINYINT(1) DEFAULT 0 AFTER `comments`;
